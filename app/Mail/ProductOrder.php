...
class ProductOrder extends Mailable
{
    ...
    {
        return $this->view('mail.to-brand.product-order')->with([
        ...
        ])->from($this->request->get('email'), $this->request->get('name'))->bcc(env('BRAND_DEVELOPER_EMAIL'))->subject('Circu | Order Product');
    }
}
