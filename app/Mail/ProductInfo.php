...
class ProductInfo extends Mailable
{
    ...
    {
        return $this->view('mail.to-brand.product-info')->with([
        ...
        ])->from($this->request->get('email'), $this->request->get('name'))->bcc(env('BRAND_DEVELOPER_EMAIL'))->subject('Circu | Product Info');
    }
}
