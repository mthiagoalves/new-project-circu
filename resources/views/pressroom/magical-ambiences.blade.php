...
<div class="container max-width-site">
    ...
    <div class="row">
      ...
      <div class="col-12">
          <div class="separator"><h3 class="background"> <span> MAGICAL AMBIENCES </span></h3></div>
      </div>
      ...
      @foreach($ambiences as $ambience)
        ...
        <a href="/img/press/magical-ambiences/high-resolution/{{$ambience->slug}}.jpg" target="_blank">
        <img src="/img/press/magical-ambiences/364x368/{{$ambience->slug}}.jpg" class="img-responsive">
...
@section('meta')
  <title>Magical Ambiences - Circu Magical Furniture</title>
  ...
  <meta property="og:url" content="http://www.circu.net/pressroom/magical-ambiences"/>
