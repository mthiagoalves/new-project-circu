...
<form method="post" class="form-popup form-parsley" action="{{ route('process.download-pocket-new-products') }}">
  
  <div class="row">

    <div class="form-popup-header col-12">
        <h1>NEW COLLECTION LAUNCH AT PARIS</h1> 
    </div>
    ...
    <div class="col-sm-6">
        ...
        <input type="hidden" name="fair_name" value="request info about new products MO 2019"/>
    ...
    <div class="col-12">
      <button type="submit" id="request-pricelist-tag" class="btn-request-piece">REQUEST INFO</button>
    </div>
