...
<form method="post" class="form-popup form-parsley" action="{{ route('process.downloadEbook') }}">

  <div class="row">

    <div class="form-popup-header col-12">
        <h1 class="text-uppercase">DOWNLOAD NOW <br> @php echo str_replace("-", " ", $ebook); @endphp </h1>
    </div>
    ...
    <input type="hidden" name="product_slug" value="{{$ebook}}"/>
    ...
    @if($ebook == "catalogue-circu-magical-furniture") 
