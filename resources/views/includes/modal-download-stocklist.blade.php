...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.download-stocklist') }}">

        <div class="row">

            <div class="form-popup-header col-12">
                <h1>DOWNLOAD STOCKLIST</h1>
            </div>

            {{ csrf_field() }}

            <input type="hidden" name="more_info" value="DOWNLOAD STOCKLIST" />
