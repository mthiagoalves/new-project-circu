...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.subscribe') }}">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <button type="submit" onclick="ga('send','event','Get Price','Request Price','Product-getprice');" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"><i class="spinner-visible fas fa-spinner fas-spin"></i>SUBSCRIBE</button>
            </div>
