<form method="POST" action="{{ route('process.product-sheet') }}" class="form-parsley form--full-grey">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 pl-half">
        ...
        <button type="submit" onclick="ga('send','event','Product Sheet','Download Now','Product-downloadarea-productsheet');" class="btn btn--primary-green w-100 mb-1">DOWNLOAD NOW</button>
