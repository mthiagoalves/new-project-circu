<form method="POST" action="{{ route('process.productMoodboard') }}" class="form-parsley form--full-grey">
...
<div class="col-12 np-lg">
        ...
        <div class="col-sm-6 offset-sm-6 pl-half">
         <button type="submit" onclick="ga('send','event','Moodboard Trends','Download Artboard','Product-downloadarea-moodboards');" class="btn btn--primary-green w-100 mb-1">DOWNLOAD ARTBOARD </button>
        </div>
