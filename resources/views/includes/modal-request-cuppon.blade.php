...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.request-cuppon') }}">
        ...
        <div class="row">
            ...
            <input type="hidden" name="more_info" value="DEALS - CUPPON 60% DISCOUNT CLOUD LAMPS" />
            ...
            <div class="col-12">
                <button type="submit" onclick="ga('send','event','Get Price','Request Price','Product-getprice');" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"><i class="spinner-visible fas fa-spinner fas-spin"></i> REQUEST CUPPON</button>
            </div>
