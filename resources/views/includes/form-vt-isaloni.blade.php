<form method="post" class="form-popup form-parsley form-access-vt" action="{{ route('process.vt-isaloni') }}">

    <div class="row m-0 p-0">

        {{ csrf_field() }}

        <input type="hidden" name="more_info" value="Salone del Milano 2022 Virtual Tour Experience" />
        <input type="hidden" name="origin" class="origin" />
        <input type="hidden" name="referrer" class="referrer" />
        <input type="hidden" name="lead_path" class="lead_path" />
        <input type="hidden" name="product_name" value="New Products 2022">
        <input type="hidden" name="product_slug" value="new-products-2022">
        ...
        <div class="col-12 col-md-5 text-right p-0 pb-3 pb-md-0 pl-md-3">
            <button type="submit" id="request-price-tag" class="btn-request-access">START EXPLORING!</button>
        </div>
