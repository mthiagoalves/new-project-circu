...
<div class="row print-d-none footer-slide pb-3">
    <div class="col-12 owl-footerbooks owl-carousel owl-slide owl-theme p-0 position-relative">
        ...
        <div class="item col-12 product-box text-center validatemail2">
            <div class="col-12 p-0 text-title-inspiraitons pt-3" style="background-color: #f7f7f7;">
                <p class="m-0"><b>INSPIRATIONS HOSPITALITY PROJECTS</b><br>COVET HOUSE</p>
            </div>
            <div class="col-12 p-0 py-3" style="background-color: #f7f7f7;">
                <a href="https://www.covethouse.eu/inspirations/inspirations-hospitality-projects/?utm_source=website&utm_medium=partnersfooter-toinspire-cc&utm_content=circu-inspirations-hospitality-projects-catalogue-cvt&utm_campaign=catalogue" target="_blank">
                    <img src="/img/footer/inspirations-hospitality-projects.png" alt="Inspirations Hospitality Projects Covet House" class="img-fluid">
                </a>
            </div>
            <div class="col-12 p-0 py-2 email-input" style="background-color: #f7f7f7;">
            ...
            <div class="col-12 p-0 pb-3" style="background-color: #f7f7f7;">
                <a rel="modal:open" href="{{route('modal-ebooks-catalogues', ['ebook' => 'inspirations-hospitality-projects'])}}" class="btn-green-underline mt-0 modal-cursor-disable-footer"><span><b>DOWNLOAD NOW</b></span></a>
            </div>
        </div>
        <div class="item col-12 product-box text-center validatemail3">
            <div class="col-12 p-0 text-title-inspiraitons pt-3" style="background-color: #f7f7f7;">
                <p class="m-0"><b>STOCKLIST SPRING SALE</b><br>CIRCU</p>
            </div>
            <div class="col-12 p-0 py-3" style="background-color: #f7f7f7;">
                <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=partnersfooter-toinspire&utm_conteudo=circu-springsale23&utm_campanha=springsale" target="_blank">
                    <img src="/img/footer/stocklist-spring-sale-footer.png" alt="Stocklist Spring Sale" class="img-fluid">
                </a>
            </div>
            <div class="col-12 p-0 py-2 email-input" style="background-color: #f7f7f7;">
        ...
        <div class="item col-12 product-box text-center validatemail5">
            <div class="col-12 p-0 text-title-inspiraitons pt-3" style="background-color: #f7f7f7;">
                <p class="m-0"><b>NEUTRAL MODERN INSPIRATIONS</b><br>CAFFE LATTE</p>
            </div>
            <div class="col-12 p-0 py-3" style="background-color: #f7f7f7;">
                <a href="https://www.caffelattehome.com/ebooks/neutral-modern-inspirations?utm_source=website&utm_medium=partnersfooter-toinspire-cl&utm_content=circu-neutral-modern-inspirations&utm_campaign=ebook" target="_blank">
                    <img src="/img/footer/neutral-modern-inspirations.png" alt="Neutral Modern Inspiration Caffe Latte" class="img-fluid">
                </a>
            </div>
            <div class="col-12 p-0 py-2 email-input" style="background-color: #f7f7f7;">
            ...
            <div class="col-12 p-0 pb-3" style="background-color: #f7f7f7;">
                <a rel="modal:open" href="{{route('modal-ebooks-catalogues', ['ebook' => 'neutral-modern-inspirations'])}}" class="btn-green-underline mt-0 modal-cursor-disable-footer"><span><b>DOWNLOAD NOW</b></span></a>
            </div>
        </div>
