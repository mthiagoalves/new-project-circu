<div class="container-fluid print-d-none">
          ...
          <div class="col-12 p-0">
            <a href="https://www.covethouse.eu/?utm_source=website&utm_medium=partnersfooter&utm_content=caffelatte-lifestyle&utm_campaign=brandawareness" target="_blank">
              <div class="row m-0 justify-content-center align-items-center">
                <img style="padding-right: 10px;" src="/img/icons/partners/logo-covet-group-w.png">
              </div>
            </a>
          </div>
        </li>
        <li style="margin-left: 1.3em;display: inline-flex;">
          <div class="col-12 p-0">
            <a href="https://www.ourluxuryhouses.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
              <div class="row m-0 justify-content-center align-items-center">
                <img style="padding-right: 10px;" src="/img/icons/partners/luxuryhouses.png">
              </div>
            </a>
          </div>
        </li>
        <li style="margin-left: 1.3em;display: inline-flex;">
          <div class="col-12 p-0">
            <a href="https://www.trendesignbook.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
              <div class="row m-0 justify-content-center align-items-center">
                <img style="padding-right: 10px;" src="/img/icons/partners/logo-trendbook.png">
              </div>
            </a>
          </div>
        </li>
        <li style="margin-left: 1.3em;display: inline-flex;">
          <div class="col-12 p-0">
            <a href="https://inspirationdesignbooks.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
              <div class="row m-0 justify-content-center align-items-center">
                <img style="padding-right: 10px;" src="/img/icons/partners/inspirations.png">
              </div>
            </a>
          </div>
        </li>
  ...
  <div class="col-12 pt-4 text-center d-lg-none" style="display:flex;align-items: center;justify-content: center;">
    <a href="https://www.ourluxuryhouses.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
      <img src="/img/icons/partners/luxuryhouses.png" class="d-block img-fluid">
    </a>
  </div>
  <div class="col-12 pt-4 text-center d-lg-none pb-4" style="display:flex;align-items: center;justify-content: center;">
    <a href="https://inspirationdesignbooks.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
      <img src="/img/icons/partners/inspirations.png" class="d-block img-fluid">
    </a>
  </div>
...
<script>
  deferLoadingScript('/js/jquery.modal.js');
  deferLoadingScript('/js/parsley.min.js');
  deferLoadingScript('/js/addtoany.js');
  deferLoadingScript('/js/functions.js');
</script>
