<div class="container-fluid print-d-none">
    ...
    @include('includes.footer.sister-brands2-test')
    ...
    <div class="row footer footer-inner footer-subscribe py-4">
      ...
      <a href="https://covetgroup.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
        <span class="mx-3" style="color:#FFFFFF;font-size:12px;letter-spacing: 1px;">TO INSPIRE ELEVATING DESIGN AND
          CRAFTSMANSHIP</span>
      </a> -->
    </div>
    ...
    <!-- <div class="col-12 pt-2 text-center d-lg-none">
      <a href="https://www.trendesignbook.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
        <span class="mx-3" style="color:#FFFFFF;font-size:12px;letter-spacing: 1px;">FORECASTING THE FUTURE OF
          DESIGN</span>
      </a>
    </div> -->
    <div class="col-12 pt-4 text-center footer-inner d-lg-none" style="display:flex;align-items: center;justify-content: center;">
        <a href="https://www.ourluxuryhouses.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
            <img src="/img/icons/partners/luxuryhouses.png" class="d-block img-fluid" alt="Logo Our Luxury Houses">
        </a>
    </div>
    <div class="col-12 pt-4 text-center footer-inner d-lg-none pb-4" style="display:flex;align-items: center;justify-content: center;">
        <a href="https://inspirationdesignbooks.com/?utm_source=website&utm_medium=partnersfooter&utm_content=circu-lifestyle&utm_campaign=brandawareness" target="_blank">
