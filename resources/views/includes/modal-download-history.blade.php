...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.download-story') }}">

        <div class="row">

            <div class="form-popup-header col-12">
                <!-- <h1>REQUEST PRICE</h1> -->
                <h3>DOWNLOAD THE FULL STORY</h3>
            </div>

            {{ csrf_field() }}

            <input type="hidden" name="more_info" value="Download the full story" />
