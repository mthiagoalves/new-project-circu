<form method="POST" action="{{ route('process.pricelist') }}" class="col-12 form-parsley">
...
<div class="col-sm-6">
    ...
    <div class="input-block">
      <button type="submit" onclick="ga('send','event','PriceList','Download Now','Allproducts-downloadpricelist');" class="btn btn--primary-green w-100 mb-1">DOWNLOAD NOW <i class="fas fa-caret-right"></i></button>
    </div>
