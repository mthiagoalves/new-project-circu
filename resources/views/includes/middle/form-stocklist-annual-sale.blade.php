...
<form method="POST" action="{{ route('process.ebook') }}" class="col-12 form-parsley form-catalogue-middle-banner form-d-block-mobile">
    ...
    <div class="row">
        ...
        <input type="hidden" name="product_slug" value="stocklist-annual-sale" />
        <input type="hidden" name="product_name" value="Stocklist Annual Sale" />
        {{ csrf_field() }}

        <h1 class="col-12 text-center mt-2 pb-2 mt-lg-0 p-0" style="color:#FFFFFF;"><b>DOWNLOAD</b> STOCKLIST <br class="d-block d-lg-none"> ANNUAL SALE</h1>
