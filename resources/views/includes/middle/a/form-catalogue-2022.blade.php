...
<form method="POST" action="{{ route('process.catalogue-new') }}" class="col-12 form-parsley form-catalogue-middle-banner form-d-block-mobile">
    ...
    <div class="row">
        ...
        <input type="hidden" name="product_name" value="New Catalogue 2022" />
        {{ csrf_field() }}

        <h1 class="col-12 text-center mt-2 mt-lg-0 p-0 new-catalogo-tilte" style="color:#FFFFFF;"><b>NEW CATALOGUE</b></h1>
        <h5 class="col-12 text-center mt-2 mt-lg-0 p-0 new-catalogo-subtilte" style="color:#FFFFFF;">A COLLECTION THAT WILL TAKE YOU TO THE CLOUDS</h5>
