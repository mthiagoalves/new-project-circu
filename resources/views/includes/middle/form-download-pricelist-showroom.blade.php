    ...
    <div class="row">
        <div class="col-12 col-xl-10 offset-0 offset-xl-1 py-0">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <a href="https://www.circu.net/circu-new-showroom?utm_origem=website&utm_meio=banner-pagallp&utm_conteudo=circu-newshowroom&utm_campanha=showroom">
                        <img src="/img/form-imgs/banner-form-pricelist-showroom-m.jpg" width="524" height="264" alt="New Products 2023 Ebook Circu Kid's Luxury Furniture" class="img-fluid d-block d-sm-none">
                        <img src="/img/form-imgs/banner-form-pricelist-showroom.png" width="992" height="500" alt="New Products 2023 Ebook Circu Kid's Luxury Furniture" class="img-fluid d-none d-sm-block">
                    </a>
                </div>
            </div>
        </div>
