<form method="POST" action="{{ route('process.pricelist-banner') }}" class="col-12 form-parsley form-catalogue-middle-banner">
    ...
    <div class="row">
        ...
        <h1 class="col-12 text-center mt-2 pb-2 mt-lg-0 p-0 d-none d-md-block" style="color:#FFFFFF;"><b>DOWNLOAD OUR PRICELIST</b></h1>

        <h5 class="col-12 text-center mt-2 mt-lg-0 p-0 d-block d-md-none" style="color:#FFFFFF;"><b>DOWNLOAD OUR PRICELIST</b></h5>
