...
<form method="POST" action="{{ route('process.catalogue-new') }}" class="col-12 form-parsley form-catalogue-middle-banner">
    ...
    <div class="row">
        ...
        <h1 class="col-12 text-center mt-2 mt-lg-0 p-0 new-catalogo-tilte" style="color:#FFFFFF;"><b>NEW CATALOGUE 2021</b></h1>
