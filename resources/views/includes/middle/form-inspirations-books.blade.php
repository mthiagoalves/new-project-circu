<form method="POST" action="{{ route('process.catalogue') }}" class="col-12 form-parsley form-catalogue-middle-banner">
    ...
    <div class="row">
        ...
        <input type="hidden" name="product_slug" value="summer-sale" />
        <input type="hidden" name="product_name" value="Summer Sale" />
        {{ csrf_field() }}

        <h5 class="col-12 text-center mt-2 mt-lg-0 p-0" style="color:#FFFFFF;"><b>DOWNLOAD</b> INSPIRATIONS BOOKS</h5>
