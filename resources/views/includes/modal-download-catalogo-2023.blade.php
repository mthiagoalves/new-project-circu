...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.download-catalogo-2023') }}">
        ...
        <div class="row">
            ...
            <input type="hidden" name="more_info" value="Download Calogue 2023" />
