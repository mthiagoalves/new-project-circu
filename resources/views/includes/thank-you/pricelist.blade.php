	...
	<div class="row">
		...
		<div class="col-12 text-center align-self-center py-5" style="background-color:#e2eced;">
				...
				<p class="col-12 font-italic font-weight-bold mr-2 ml-2 mb-5">
					...
					Each magical product is unique and exclusive, our team will send you an email with your request.<br>
				...
				<a class="btn-border-blue col-lg-2 col-md-4 col-sm-3 col-xs-1" href="{{ route('stocklist') }}" target="_blank" role="button"><b>CHECK STOCKLIST</a>
