...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12 text-center align-self-center py-5" style="background-color:#e2eced;">
            ...
            <h4 class="text-uppercase my-4 pt-4">THANK YOU FOR YOUR REQUEST</h4>

            <p class="font-italic font-weight-bold mr-2 ml-2 mb-5">
                Welcome to Circu's Magical World.<br> If you need anything else, please <a href="https://api.whatsapp.com/send?phone=351911780428&amp;text=Hello, I'm interested in knowing more about Circu. Can you help me?" target="_blank">contact us </a>
            </p>
            ...
            <a class="btn-border-green col-lg-2 col-md-4 col-sm-4 col-xs-1" href="{{ URL::previous() }}" role="button"></i><i class="fas fa-chevron-left"></i> RETURN</a>

            <a class="btn-border-blue col-lg-2 col-md-4 col-sm-3 col-xs-1" href="{{ $array_product[0]['url'] }}" id="target_url" role="button" target="_blank">DOWNLOAD <b>HERE</b></a>
