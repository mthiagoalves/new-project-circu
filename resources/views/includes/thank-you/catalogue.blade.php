...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-12 text-center align-self-center py-5" style="background-color:#e2eced;">
				...
				<p class="col-12 font-italic font-weight-bold mr-1 ml-1 mb-1">
					Welcome to Circu’s enchanted world.<br>
					We appreciate your interest and it’s a pleasure to share with you our magical catalogue.<br>
					Your inquiry is being processed, and we will contact you shortly by email.
				</p>
				...
				<a class="btn-border-blue col-lg-2 col-md-4 col-sm-3 col-xs-1" href="https://www.circu.net/docs/catalogue-circu-magical-furniture.pdf" target="_blank" role="button" download>DOWNLOAD <b>HERE</b></a>
