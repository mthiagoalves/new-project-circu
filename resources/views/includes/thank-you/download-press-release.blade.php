	...
	<div class="row">
		...
		<div class="col-12 text-center align-self-center py-5" style="background-color:#e2eced;">
				...
				<p class="col-12 font-italic font-weight-bold mr-2 ml-2 mb-5">
					Welcome to Circu's Magical World.
					<br><br>
					Circu was built under a dream! The dream is to allow children to dream their own dreams
					<br>
					and to really give them space to be and live their fantasies and magical world.
					<br>
					Our hand-crafted and hand-tailored products are made with the finest materials, combined with a lot of passion,
					<br>
					so we can deliver only the highest quality furnishings.
				</p>
				...
				@if(file_exists('./docs/media-pack/'.$press_release.'.zip'))
          {{-- <a href="/docs/media-pack/{{ $pressrelease->slug }}.zip"> --}}
          <a class="btn-border-blue col-lg-2 col-md-4 col-sm-3 col-xs-1" href="/docs/media-pack/{{ $press_release }}.zip" role="button" download>DOWNLOAD <b>HERE</b></a>
        @else
          <a class="btn-border-blue col-lg-2 col-md-4 col-sm-3 col-xs-1" href="/docs/press-release/{{ $press_release }}.pdf" role="button" download>DOWNLOAD <b>HERE</b></a>
        @endif
