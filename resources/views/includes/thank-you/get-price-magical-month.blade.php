...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12 text-center align-self-center py-5">
            ...
            <h4 class="text-uppercase mb-4 pt-2" style="color: #8bb9b6 !important;">You are now part of our Magical Family</h4>

            <p class="col-12 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                Enjoy our very first floor sample campaign, and get your exclusive acess to our unique deals!<br> On your e-mail you can donwload our floor sample list.<br>Soon our commercial team will enter in contact with you. If you are in a hurry
                you can contacts <br class="d-none d-md-block">throught out <a href="mailto:info@ciru.net" style="text-decoration:none !important; color: #8bb9b6 !important;">info@ciru.net</a> or call <a href="tel:+351 914 929 073" style="text-decoration:none !important; color: #8bb9b6 !important;">+351 914 929 073</a>
            </p>
            ...
            <p class="col-12 font-weight-bold mr-2 ml-2 mb-4" style="color: #8bb9b6 !important;">
                <a href="https://www.circu.net/magical-month" style="text-decoration:none !important; color: #8bb9b6 !important;font-size: 15px;"><i class="fas fa-caret-left"></i> <span style="color: #8bb9b6 !important;font-size: 15px; border-bottom:1px solid #8bb9b6;">GO BACK</span></i></a>
            </p>

            <p class="col-12 font-weight-bold mr-2 ml-2 mb-4" style="color: #8bb9b6 !important;font-size: 18px;">
                Meanwhile, here are some things we believe you'll like as well:
            </p>
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 p-0">
                    <div class="col-12 col-md-6 float-left pb-3 pb-md-0">
                        <div class="col-12 pb-2">
                            <img class="img-fluid" src="/img/thank-you/ty_catalogo.jpg">
                        </div>
                        <a href="https://www.circu.net/download-catalogue" id="request-price-tag" class="btn-request-piece" style="color: #FFFFFF;font-size: 0.75rem;letter-spacing: 0.1rem;font-weight: bold;border: 1px solid transparent;padding: .375rem 1.75rem;background-color: #89bab6;">DOWNLOAD CATALOGUE <i class="fas fa-caret-right"></i></a>
                    </div>
                    <div class="col-12 col-md-6 float-left">
                        <div class="col-12 pb-2">
                            <img class="img-fluid" src="/img/thank-you/ty_pricelist.jpg">
                        </div>
                        <a href="https://www.circu.net/request-pricelist" id="request-price-tag" class="btn-request-piece" style="color: #FFFFFF;font-size: 0.75rem;letter-spacing: 0.1rem;font-weight: bold;border: 1px solid transparent;padding: .375rem 1.75rem;background-color: #89bab6;">DOWNLOAD PRICELIST <i class="fas fa-caret-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 social_actions pb-5">
                <h5 class="mt-5 mb-2" style="color: #8bb9b6 !important;">Follow us</h5>
