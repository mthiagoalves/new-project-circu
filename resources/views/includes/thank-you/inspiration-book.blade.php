	...
	<div class="row">
		...
		<div class="col-12 text-center align-self-center py-5" style="background-color:#e2eced;">
				...
				<p class="col-12 font-italic font-weight-bold mr-2 ml-2 mb-4">
					...
					You're in now and we promise that you will not miss anything about us.
				</p>
				...
				<a class="btn-action-blue" href="/docs/inspirations-book-circu-magical-furniture.pdf" role="button" download>DOWNLOAD <b>HERE</b></a>
