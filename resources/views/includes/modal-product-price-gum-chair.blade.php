...
<body>
    ...
    <div class="row">
        ...
        <div class="col-12 p-0 extra" id="extra" style="display: none">
            <form method="post" class="form-popup form-parsley" action="{{ route('process.product-price-magical-month-gum-chair') }}">
                {{ csrf_field() }}

                <input type="hidden" name="more_info" value="- Professional" />
                <input type="hidden" name="product_name" value="Gum Armchair" />
