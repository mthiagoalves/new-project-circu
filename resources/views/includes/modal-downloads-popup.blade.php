...
<form method="post" id="modalDownload" class="form-popup form-parsley" action="{{ route('process.pricelistPop') }}">
  
  <div class="row">

    <div class="form-popup-header col-12">
        <h1>REQUEST PRICELIST</h1> 
    </div>
    ...
    <div class="col-12">
      <button type="submit" id="request-pricelist-tag" class="btn-request-piece">REQUEST PRICELIST</button>
    </div>
