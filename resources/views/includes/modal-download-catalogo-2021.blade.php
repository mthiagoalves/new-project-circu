...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.download-catalogo-2021') }}">

        <div class="row">

            <div class="form-popup-header col-12">
                <h1>DOWNLOAD</h1>
                <h3>CATALOGUE 2021</h3>
            </div>

            {{ csrf_field() }}

            <input type="hidden" name="more_info" value="Download Calogue 2021" />
