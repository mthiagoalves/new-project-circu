        ...
        <div class="col-12 text-center align-self-center py-5">
            ...
            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    Dear {{ $name_user }}, we sent right now our {{ $name_ebook }} to your email {{ $email_user }}. As soon as possible, our team will enter in contact with you with more details about our magical brand and products.
                </p>
            </div>
            ...
            <div class="row pb-1">
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/request-pricelist?utm_source=website&utm_medium=thankyou-page&utm_content=circu-catalog&utm_campaign=pricelist&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">PRICELIST</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/pricelist.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                            <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 6px 0px; border: 1.5px solid white; color: white; font-size: 13px; font-weight: bold; width: 210px;">FREE DOWNLOAD</p>
                        </div>
                    </a>
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/100-luxury-kids-rooms?utm_source=website&utm_medium=thankyou-page&utm_content=circu-catalogue&utm_campaign=100luxurykidsrooms&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
