        ...
        <div class="col-12 text-center align-self-center py-5">
            ...
            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    Dear {{ $name_user }}, we sent right now an email with our {{ $name_ebook }} to your {{ $email_user }}. As soon as possible, our team will enter in contact with you with more details about our magical brand and products.
                </p>
            </div>
            ...
            <div class="row pb-1">
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/circu-new-showroom?utm_source=website&utm_medium=thankyou-page&utm_conteudo=circu-newshowroom&utm_campanha=showroom&utm_term=aferraz">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">NEW SHOWROOM</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/pricelist-showroom-thank-you-page.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                            <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 6px 0px; border: 1.5px solid white; color: white; font-size: 13px; font-weight: bold; width: 210px;">KNOW MORE</p>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/catalogue-circu-magical-furniture/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-ebook&utm_campaign=catalogue&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">CATALOGUE</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/catalogue.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                ...
                @if($name_ebook == 'New Products 2023')
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/magical-kids-bedrooms-playground-ideas/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-ebook&utm_campaign=ourmagicalrooms&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">OUR MAGICAL ROOMS</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/magical-rooms2.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                            <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 6px 0px; border: 1.5px solid white; color: white; font-size: 13px; font-weight: bold; width: 210px;">FREE DOWNLOAD</p>
                        </div>
                    </a>
                ...
                @else
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/new-products-2023/utm_source=website&utm_medium=thankyou-page&utm_content=circu-product-price&utm_campaign=newproducts">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">NEW PRODUCTS</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/new-products-2023-tks.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                            <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 6px 0px; border: 1.5px solid white; color: white; font-size: 13px; font-weight: bold; width: 210px;">FREE DOWNLOAD</p>
                        </div>
                    </a>
