...
<div class="container-fluid pb-5 px-0">
    <div class="row">
        <div class="col-12 text-center align-self-center py-5">
            ...
            <h4 class="text-uppercase mb-4 pt-2" style="color: #8bb9b6 !important;">WELCOME TO OUR MAGICAL FAMILY</h4>

            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    @if($name_user == '')
                    Thank you so much for subscribing to our newsletters. From now we will send you exclusive content to your email {{ $email_user }} that will inspire you to create enchanted projects where dreams come true.
                    @else
                    Dear {{ $name_user }}, thank you so much for subscribing to our newsletters. From now we will send you exclusive content to your email {{ $email_user }} that will inspire you to create enchanted projects where dreams come true.
                    @endif
                </p>
            </div>
            ...
            <div class="row pb-1">
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/catalogue-circu-magical-furniture/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-subscriber&utm_campaign=catalogue&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/new-products-2022/utm_source=website&utm_medium=thankyou-page&utm_content=circu-product-price&utm_campaign=newproducts22">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">NEW PRODUCTS</p>
                        </div>
                        <img class="img-fluid w-100" src="/img/new-thank-you/thank-you-2/new-products.jpg">
                        <div class="position-absolute" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                            <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 6px 0px; border: 1.5px solid white; color: white; font-size: 13px; font-weight: bold; width: 210px;">FREE DOWNLOAD</p>
                        </div>
                    </a>
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/magical-kids-bedrooms-playground-ideas/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-subscriber&utm_campaign=ourmagicalrooms&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
