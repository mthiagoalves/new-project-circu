...
<meta property="og:image" content="http://www.circu.net/images/circu-magical-furniture-logo.png" /> @endsection @section('main-content')
        ...
        <div class="col-12 text-center align-self-center py-5 px-0">
            ...
            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    Dear {{ $name_user }}, your request is being processed and our team will enter in contact with you as soon as possible in order to give you the content you requested and to answer any doubt you might have about this product and our magical brand.
                </p>
            </div>
