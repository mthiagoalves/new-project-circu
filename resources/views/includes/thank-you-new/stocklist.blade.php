        ...
        <div class="col-12 text-center align-self-center py-5">
            ...
            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    Dear {{ $name_user }}, you can have access to our stocklist on your email {{ $email_user }}. Our team will enter in contact with you with more details about our prices, ordering process and details about our products and our magical brand.
                </p>
            </div>
            ...
            <div class="row pb-1">
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/inspirations/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-pricelist&utm_campaign=stocklist&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
                            <p class="m-0" style="color: white; font-size: 20px; font-weight: bold;">INSPIRATIONS</p>
                        </div>
                        <img class="img-fluid" src="/img/new-thank-you/thank-you-2/ready-to-ship.jpg">
                ...
                <div class="col-12 col-md-3 p-1">
                    <a href="https://www.circu.net/ebook/magical-kids-bedrooms-playground-ideas/?utm_source=website&utm_medium=thankyou-page&utm_content=circu-stocklist&utm_campaign=ourmagicalrooms&utm_term=hsantos">
                        <div class="position-absolute col-12" style="left: 50%; transform: translate(-50%, 0%);top: 7%;">
