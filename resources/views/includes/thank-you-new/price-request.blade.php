...
<div class="container-fluid pb-5">
    <div class="row">
        <div class="col-12 text-center align-self-center py-5 px-0">

            <h4 class="text-uppercase mb-4 pt-2" style="color: #8bb9b6 !important;">THANK YOU FOR YOUR REQUEST</h4>

            <div class="row justify-content-center">
                <p class="col-12 col-md-5 font-weight-bold mr-2 ml-2 mb-4" style="color: #666666 !important;line-height: 25px;">
                    Dear {{ $name_user }}, we sent you an email to {{ $email_user }} with the price of this enchanted product, and our sales team will enter in contact with you, as soon as possible, with more details about this product and other iconic pieces you might be
                    interested.
                </p>
            </div>
            ...
            <div class="row">
                <p class="col-12 font-weight-bold mr-2 ml-2 my-4" style="color: #8bb9b6 !important;font-size: 18px;">
                    Get exclusive content
                </p>
            </div>
            <div class="row justify-content-center pb-4">
                <div class="col-12 col-md-10 p-0">
                    <div class="col-12 col-md-6 float-left px-0 b-3 pb-md-0">
                        <a href="https://www.circu.net/circu-new-showroom?utm_source=website&utm_medium=thankyou-page&utm_conteudo=circu-newshowroom&utm_campanha=showroom&utm_term=aferraz">
                            <div class="col-12 pb-2 px-0 pl-1">
                                <img class="img-fluid d-none d-md-block w-100" src="/img/new-thank-you/thank-you-1/banners/pricelist-showroom-thank-you-page.jpg">
                                <img class="img-fluid d-block d-md-none" src="/img/new-thank-you/thank-you-1/banners/stocklist-annual-sale-tks-m.jpg">
                            </div>
                            <div class="position-absolute d-none d-md-block" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                                <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 2px 0px; border: 1.5px solid white; color: white; font-size: 12px; font-weight: bold; width: 210px;">DOWNLOAD NOW</p>
                            </div>
                            <div class="position-absolute d-block d-md-none" style="left: 50%; transform: translate(-50%, 0%);bottom: 8%;">
                                <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 2px 0px; border: 1.5px solid white; color: white; font-size: 12px; font-weight: bold; width: 210px;">DOWNLOAD NOW</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-12 col-md-6 float-left px-0 pb-3 pb-md-0">
                    <a href="https://www.circu.net/ebook/new-products-2023?utm_source=thankyou-page&utm_medium=email&utm_content=circu-product-price&utm_campaign=newproducts">
                            <div class="col-12 pb-2 px-0 pr-1">
                                <img class="img-fluid d-none d-md-block w-100" src="/img/new-thank-you/thank-you-1/banners/new-products-2023-tks.jpg" alt="New products 2023 Circu Mgical Furniture">
                                <img class="img-fluid d-block d-md-none w-100" src="/img/new-thank-you/thank-you-1/banners/new-products-2023-tks-m.jpg" alt="New products 2023 Circu Mgical Furniture">
                            </div>
                            <div class="position-absolute d-none d-md-block" style="left: 50%; transform: translate(-50%, 0%);bottom: 4%;">
                                <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 2px 0px; border: 1.5px solid white; color: white; font-size: 12px; font-weight: bold; width: 210px;">DOWNLOAD EBOOK</p>
                            </div>
                            <div class="position-absolute d-block d-md-none" style="left: 50%; transform: translate(-50%, 0%);bottom: 10%;">
                                <p class="m-0" style="background-color: rgba(255,255,255,0.2); padding: 2px 0px; border: 1.5px solid white; color: white; font-size: 12px; font-weight: bold; width: 210px;">DOWNLOAD EBOOK</p>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row">
                <p class="col-12 font-weight-bold mr-2 ml-2 pt-5" style="color: #8bb9b6 !important;font-size: 18px;">
...
<meta property="og:image" content="http://www.circu.net/images/circu-magical-furniture-logo.png" /> @endsection @section('footer-includes')
