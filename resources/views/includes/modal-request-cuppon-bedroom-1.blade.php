...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.request-cuppon-bedroom') }}">

        <div class="row">

            <div class="form-popup-header col-12">
                <h1>CLOUD ROOM DISCOUNT</h1>
            </div>

            {{ csrf_field() }}

            <input type="hidden" name="more_info" value="DEALS - CLOUD ROOM DISCOUNT " />
            ...
            <div class="col-12">
                <h4 style="font-size: 11px !important;">*Not comulative with other campaigns</h4>
            </div>
            <div class="col-12">
                <button type="submit" onclick="ga('send','event','Get Price','Request Price','Product-getprice');" id="request-price-tag" class="btn-request-piece btn-prevent-multiple"><i class="spinner-visible fas fa-spinner fas-spin"></i>GET YOUR CUPPON</button>
            </div>
