...
<body>
  ...
  <form method="post" class="form-popup form-parsley" action="{{ route('process.product-order', $product->slug) }}">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <button type="submit" onclick="ga('send','event','Buy Now','Request Product','Product-ordernow');" id="buy-now-tag" class="btn-request-piece">REQUEST PRODUCT</button>
      </div>
