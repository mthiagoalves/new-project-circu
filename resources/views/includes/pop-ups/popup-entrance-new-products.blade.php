            ...
            <div class="modal-body p-0" aria-hidden="true">
                <!-- <div class="col-12 p-0" style="background-color: transparent !important;">
                    ...
                    <div class="col-12 p-0 pt-3 text-center">
                        <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=popup&utm_conteudo=circu-springsale23&utm_campanha=springsale">
                            <img class="img-fluid" src="/img/popup/new-products/popup-entrance-spring-sale.jpg" alt="Stocklist Spring Sale Circu" />
                        </a>
                    </div>
                </div>-->
                <div class="col-12 p-0" style="background-color: transparent !important;">
                    ...
                    <div class="col-12 p-0 pt-3 text-center">
                        <a href="https://www.circu.net/isaloni-milan?utm_origem=website&utm_meio=popup&utm_conteudo=circu-isaloni23&utm_campanha=isaloni23">
                            <img class="img-fluid" src="/img/popup/new-products/isaloni-popup-entrance.jpg" alt="Isaloni 2023" />
                        </a>
                    </div>
                </div>
            </div>
