...
<style>
    ...
    .fcurrent_color::after,
    .fcurrent_drawer::after {
        content: '';
        position: absolute;
        top: 0;
        width: 15px;
    ...
    /* .fcurrent_color.notavaible::after {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        background-color: red !important;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    .fcurrent_color.notavaible img {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        filter: blur(2px);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } */

    .trigger-opt-item-size {
        max-width: 120px;
        width: 100%;
    }
    ...
    .fcurrent_size button {
        cursor: pointer;
        background-color: #89bab6;
        border: 1px solid #89bab6 !important;
    }
        ...
        <div class="col-12 col-lg-7 product-slide print-d-none">
            <div class="row">
                ...
                <div class="col-2 product-slide--nav d-none d-lg-inline-block text-center d-print-none ">
                    @if ($sizes[0]->product_sample_size == '[]')
                    @if ($drawers[0]->product_sample_drawer == '[]')
                    @if (!$samples->isEmpty())
                    ...
                    @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $sample->slug . '/' . $product->slug . '-circu-magical-furniture-' . $sample->slug . '-' . $i . '.gif'))
                        <div>
                            <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.gif" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                        </div>
                        @else
                        <div>
                            <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.jpg" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                        </div>
                        @endif
                        @endfor
                        @endforeach
                        ...
                        @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $product->slug . '-circu-magical-furniture-' . $i . '.gif'))
                            <div>
                                <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                            </div>
                            @else
                            <div>
                                <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                            </div>
                            @endif
                            @endfor
                            @endif
                            ...
                            @if ($drawer->product_sample_drawer != '[]')
                            @foreach ($drawer->product_sample_drawer as $product_drawer)
                            @php
                            $directory = './img/products/' . $product->slug . '/details/' . $drawer->slug . '/';
                            $filecount = count(glob($directory . '*.{jpg,gif}', GLOB_BRACE));
                            @endphp
                            @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $drawer->slug . '/' . $product->slug . '-circu-magical-furniture-' . $i . '.gif'))
                                <div>
                                    <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                                </div>
                                @else
                                <div>
                                    <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                                </div>
                                @endif
                                @endfor
                                @endforeach
                                ...
                                @if ($size->product_sample_size != '[]')
                                @foreach ($size->product_sample_size as $product_size)
                                @php
                                $directory = './img/products/' . $product->slug . '/details/' . $size->slug . '/' . $product_size->product_sample->sample->slug . '/';
                                $filecount = count(glob($directory . '*.{jpg,gif}', GLOB_BRACE));
                                @endphp
                                @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $size->slug . '/' . $product_size->product_sample->sample->slug . '/' . $product->slug . '-circu-magical-furniture-' . $product_size->product_sample->sample->slug . '-' . $i . '.gif'))
                                    <div>
                                        <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.gif" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                                    </div>
                                    @else
                                    <div>
                                        <img draggable="false" src="/img/products/{{ $product->slug }}/details/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.jpg" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" class="img-fluid" />
                                    </div>
                                    @endif
                                    @endfor
                                    @endforeach
                                    ...
                                    @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/ambiences/' . $product->slug . '-circu-magical-furniture-' . $i . '.jpg'))
                                        <div>
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/ambiences/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" class="img-fluid" />
                                        </div>
                                        @endif
                                        @endfor
                                        ...
                                        @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/more/' . $product->slug . '-circu-magical-furniture-' . $i . '.jpg'))
                                            <div>
                                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/more/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                            </div>
                                            @endif
                                            @endfor
                    ...
                    @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $sample->slug . '/' . $product->slug . '-circu-magical-furniture-' . $sample->slug . '-' . $i . '.gif'))
                        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $sample->slug }}">
                            <a href="/img/products/{{ $product->slug }}/zoom/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.gif" itemprop="contentUrl" data-size="1679x1108">
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.gif" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                            </a>
                        </figure>
                        @else
                        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $sample->slug }}">
                            <a href="/img/products/{{ $product->slug }}/zoom/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.jpg" itemprop="contentUrl" data-size="1679x1108">
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sample->slug }}-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                            </a>
                        </figure>
                        @endif
                        @endfor
                        ...
                        @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $product->slug . '-circu-magical-furniture-' . $i . '.gif'))
                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                <a href="/img/products/{{ $product->slug }}/zoom/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" itemprop="contentUrl" data-size="1679x1108">
                                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                </a>
                            </figure>
                            @else
                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                <a href="/img/products/{{ $product->slug }}/zoom/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="contentUrl" data-size="1679x1108">
                                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                </a>
                            </figure>
                            @endif
                            @endfor
                            ...
                            @endphp
                            @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $drawer->slug . '/' . $product->slug . '-circu-magical-furniture-' . $i . '.gif'))
                                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $drawer->slug }}">
                                    <a href="/img/products/{{ $product->slug }}/zoom/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" itemprop="contentUrl" data-size="1679x1108">
                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.gif" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                    </a>
                                </figure>
                                @else
                                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $drawer->slug }}">
                                    <a href="/img/products/{{ $product->slug }}/zoom/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="contentUrl" data-size="1679x1108">
                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $drawer->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                    </a>
                                </figure>
                                @endif
                                @endfor
                                ...
                                @endphp
                                @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/' . $size->slug . '/' . $product_size->product_sample->sample->slug . '/' . $product->slug . '-circu-magical-furniture-' . $product_size->product_sample->sample->slug . '-' . $i . '.gif'))
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $size->slug }}-{{ $product_size->product_sample->sample->slug }}">
                                        <a href="/img/products/{{ $product->slug }}/zoom/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.gif" itemprop="contentUrl" data-size="1679x1108">
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.gif" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                        </a>
                                    </figure>
                                    @else
                                    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample="{{ $size->slug }}-{{ $product_size->product_sample->sample->slug }}">
                                        <a href="/img/products/{{ $product->slug }}/zoom/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.jpg" itemprop="contentUrl" data-size="1679x1108">
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $size->slug }}/{{ $product_size->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $product_size->product_sample->sample->slug }}-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                        </a>
                                    </figure>
                                    @endif
                                    @endfor
                                    ...
                                    @for ($i = 1; $i <= $filecount; $i++) @if (file_exists('./img/products/' . $product->slug . '/details/ambiences/' . $product->slug . '-circu-magical-furniture-' . $i . '.jpg'))
                                        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                            <a href="/img/products/{{ $product->slug }}/zoom/ambiences/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.png" itemprop="contentUrl" data-size="1679x1108">
                                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/ambiences/{{ $product->slug }}-circu-magical-furniture-{{ $i }}.jpg" itemprop="thumbnail" alt="Image description" class="img-fluid" />
                                            </a>
                                        </figure>
                                        @endif
                                        @endfor
                ...
                <div class="col-12 p-0 text-center d-block d-md-none d-print-none ">
                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/scroll.svg" style="top:1rem;right:1.8rem;z-index:9;" width="30" height="30">
                </div>

                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/zoom-icon.png" id="zoom_icon" class="position-absolute d-print-none " style="top:1rem;right:1.8rem;z-index:9;" width="30" height="30">
            </div>
        </div><!-- product-slide -->
        <div class="col-12 text-center d-none d-print-block">
            @if ($sizes->isEmpty())
            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $sizes[0]->slug }}/{{ $sizes[0]->product_sample_size[0]->product_sample->sample->slug }}/{{ $product->slug }}-circu-magical-furniture-{{ $sizes[0]->product_sample_size[0]->product_sample->sample->slug }}-1.jpg" style="width:600px" alt="Image description" class="img-fluid print-size-color" />
            @else
            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/details/{{ $product->slug }}-circu-magical-furniture-1.jpg" style="width:600px" alt="Image description" class="img-fluid print-size-color" />
            @endif
        </div>
        <div class="col-12 col-lg-4 product-details pl-0 pl-lg-4 pr-0 pt-4 pt-md-0">
            <div class="row">
                <div class="col-12 order-3 order-lg-1">
                    <div class="product-details__intro clearfix col mb-3 p-0">
                        <div class="float-left">
                            @if ($product->slug == 'mogli-playhouse-gym' || $product->slug == 'mogli-playhouse-bed')
                            <h1 class="product-details_name" style="color: #8bb9b6; font-size: 1.3rem; margin-bottom: 0.2rem; text-transform: uppercase;">{{ $product->name }}</h1>
                            @else
                            <h1 class="product-details__name">{{ $product->name }}</h1>
                            @endif
                            @if ($product->slug == 'mogli-playhouse-gym' || $product->slug == 'mogli-playhouse-bed')
                            <h2 class="product-details__category cat-alt">
                ...
                <div class="col-12 order-4 order-lg-2">
                ...
                <div class="col-12 order-5 order-lg-3">
                    <div class="row m-0 mb-1 d-print-none">
                        <div class="col-10 block p-0 pr-1">
                            <a rel="modal:open" class="btn btn--primary-green w-100 modal-cursor-disable" href="{{ route('modal-product-price', $product->slug) }}">
                                <span>GET PRICE <i class="fas fa-caret-right"></i></span>
                            </a>
                        </div>
                        <div class="col-2 p-0">
                ...
                <div class="col-12 order-6 order-lg-4">
                    <div class="row m-0 d-print-none">
                ...
                <div class="col-12 order-7 order-lg-5">
                    <div class="product-details__description mb-3 pt-3 d-print-none">
                        ...
                        <div class="row m-0 align-items-center">
                            <div class="col-8 p-0">
                                ...
                                <div class="dimensions-product" style="line-height: 22px;font-size: 12px;letter-spacing: 1px;color: #6c757d;">
                            ...
                            <div class="col-4 p-0 ">
                                ...
                                @endphp
                                @if ($filecountimg > 1)
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg" class="img-fluid human-scale" alt="circu human scale">
                                @elseif($filecountimg == 1)
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg" class="img-fluid" alt="circu human scale">
                                @else
                                @endif
                            </div>
                        </div>
                ...
                <div class="col-12 order-8 order-lg-6">
                    @if ($sizes[0]->product_sample_size == '[]')
                    ...
                    @endif
                    @elseif($sizes[0]->product_sample_size != '[]' && $samples->isEmpty())
                    <div class="product-details__description mb-3 d-print-none">
                        <h6 class="heading-secondaryr" style="color:#94b7b3 !important;font-size: 13px !important;">
                            STANDARD FINISHES</h6>
                        <div style="line-height: 22px;font-size: 13px;letter-spacing: 1px;color: #6c757d;">
                ...
                <div class="col-12 order-1 order-lg-7">
                    @if ($drawers[0]->product_sample_drawer != '[]')
                    <div class="product-samples d-print-block">
                        <h6 class="heading-secondaryr mt-4" style="color:#94b7b3 !important;font-size: 13px !important;">PRODUCT OPTIONS</h6>
                        <div class="row m-0">
                            @foreach ($drawers as $drawer)
                            @if ($drawer->product_sample_drawer != '[]')
                            <a class="trigger-opt-item-drawer {{ $loop->first ? 'fcurrent_drawer' : '' }} position-relative ">
                                {{-- <button data-target="{{$drawer->slug}}" data-product="{{$drawer->slug}}">{{$drawer->name}}</button> --}}
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/mini-samples/{{ $drawer->slug }}.jpg" data-name-product="{{ $product->name }}" data-price-euro="{{ $drawer->product_sample_drawer[0]->price_euro }}" data-price-dollar="{{ $drawer->product_sample_drawer[0]->price_dollar }}" data-target="{{ $drawer->slug }}" data-size-product="{{ $drawer->product_sample_drawer[0]->product_size }}" data-product="{{ $product->slug }}" data-name-option="{{ $product->name }} {{ $drawer->name }}" class="img-fluid mr-1" style="width: 50px;cursor:pointer;">
                            </a>
                            @endif
                            @endforeach
                        </div>
                    ...
                    @endif
                    @if($product->has_sizeoptions == '1')
                    <div class="product-samples d-print-block">
                        @if($product->slug == 'mushroom-pendant' || $product->slug == 'mogli-playhouse-bed' || $product->slug == 'mogli-playhouse-gym' || $product->slug == 'bubble-gum-dressing-table' || $product->slug == 'merida-bed' || $product->slug == 'merida-corner-bed')
                        <h6 class="heading-secondaryr mt-2" style="color:#94b7b3 !important;font-size: 13px !important;">PRODUCT OPTIONS</h6>
                        @else
                        <h6 class="heading-secondaryr mt-4" style="color:#94b7b3 !important;font-size: 13px !important;">SIZE OPTIONS</h6>
                        @endif
                        ...
                        <div class="row m-0">
                            ...
                            @foreach ($sizes as $size)
                            @if ($size->product_sample_size != '[]')
                            @foreach ($size->product_sample_size as $product_sample_id)
                            @if ($product_sample_id->product_sample_id != 0)
                            @php
                            $color_size_avaible[$size->slug] = $product_sample_id->product_sample->sample->slug;
                            @endphp
                            <span class="d-none color_size_avaible_{{ $size->slug }}" data-target="{{ $color_size_avaible[$size->slug] }}"></span>
                            @endif
                            @endforeach
                            @if($product->slug == 'mushroom-pendant' || $product->slug == 'mogli-playhouse-bed' || $product->slug == 'mogli-playhouse-gym' || $product->slug == 'bubble-gum-dressing-table')
                            <a class="col-2 p-0 trigger-opt-item-size button-size {{ $loop->first ? 'fcurrent_size' : '' }} position-relative pr-2">
                                <button style="background: url(/img/products/{{ $product->slug }}/mini-samples/{{ $size->slug }}.jpg);height: 8.5vh; background-repeat: no-repeat; background-position: center; background-size: contain;" data-target="{{ $size->slug }}" data-name-product="{{ $product->name }}" data-price-euro="{{ $size->product_sample_size[0]->price_euro }}" data-price-dollar="{{ $size->product_sample_size[0]->price_dollar }}" data-name-size="{{ $product->name }} {{ $size->name }}" data-size="{{ $size->name }}" data-size-product="{{ $size->product_sample_size[0]->product_size }}" data-product="{{ $product->slug }}"></button>
                            </a>
                            @else
                            <a class="col-4 p-0 trigger-opt-item-size button-size {{ $loop->first ? 'fcurrent_size' : '' }} position-relative pr-2">
                                <button data-target="{{ $size->slug }}" data-name-product="{{ $product->name }}" data-price-euro="{{ $size->product_sample_size[0]->price_euro }}" data-price-dollar="{{ $size->product_sample_size[0]->price_dollar }}" data-name-size="{{ $product->name }} {{ $size->name }}" data-size-product="{{ $size->product_sample_size[0]->product_size }}" data-product="{{ $product->slug }}">{{ $size->name }}</button>
                            </a>
                            @endif
                            @endif
                            @endforeach
                    ...
                    <div class="product-samples d-print-block">
                        ...
                        <div class="row m-0">
                            @foreach ($samples as $sample)
                            <a class="trigger-opt-item {{ $loop->first ? 'fcurrent_color' : '' }} position-relative">
                                <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/mini-samples/{{ $sample->slug }}.jpg" alt="" data-target="{{ $sample->slug }}" data-product="{{ $product->slug }}" class="img-fluid mr-1" style="width: 50px;">
                            </a>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="product-details__actions mt-3 d-print-none  col-12 col-lg-12 order-9 order-lg-8">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-12 p-0 d-print-none">
                            <a class="btn btn--primary-grey w-100 talk-with-us" href="{{ route('modal-product-price', $product->slug) }}" rel="modal:open" target="_blank"><span>TALK WITH A
                ...
                <div class="col-12 text-left product_options position-relative d-print-none pt-4 order-10 order-lg-9">
                    <div class="row m-0 align-items-center">
                        ...
                        <div class="col-7 col-md-6 mt-4 p-0" style="text-align: end;">
                            ...
                            <div class="social-share d-inline">
                                <ul class="a2a_kit">
                                    ...
                                    <li><a class="a2a_button_email"><img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/social/email.png" alt="share on email"></a>&nbsp;</li>
                                    <li><a class="a2a_button_whatsapp"><img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/social/whatsapp.png" alt="share on whatsapp"></a></li>
                                    <li><a class="a2a_button_facebook"><img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/social/facebook.png" alt="share on facebook"></a></li>
                                    <li><a class="a2a_button_pinterest"><img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/social/pinterest.png" alt="share on pinterest"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
$product->slug == 'bubble-gum-desk'||
$product->slug == 'mogli-playhouse-bed'||
$product->slug == 'mogli-playhouse-gym'||
$product->slug == 'mushroom-pendant'||
$product->slug == 'merida-bed'||
$product->slug == 'merida-corner-bed')

<div class="container-fluid text-center p-0 swiper-ambients mb-2 d-print-none " style="overflow: hidden;">
        ...
        <div class="swiper-wrapper my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
            ...
            <figure class="swiper-slide slider-main find-them-all" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" style="margin-bottom: 0;">
                ...
                <a href="/img/products/ambiences/zoom/{{ $article_product->article->slug }}.png" class="link-slides" itemprop="contentUrl" data-size="1679x1108">
                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/ambiences/{{ $article_product->article->slug }}.jpg" itemprop="thumbnail" alt="Image description" style="cursor: pointer;" class="img-fluid d-none d-md-block pswp--open-r imgs-hotspots" />
                    @if($product->slug == 'little-bunny-office-chair' || $product->slug == 'fantasy-air-bookcase-limited-edition')
                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/ambiences/resize-mobile/{{ $article_product->article->slug }}-m.jpg" itemprop="thumbnail" alt="Image description" style="cursor: pointer;" class="img-fluid d-block d-md-none pswp--open-r" />
                    @else
                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/ambiences/{{ $article_product->article->slug }}-m.jpg" itemprop="thumbnail" alt="Image description" style="cursor: pointer;" class="img-fluid d-block d-md-none pswp--open-r" />

                    @endif
                </a>
                @foreach (App\Article_product::where('article_id', $article_product->article->id)->get() as $hotspot)
                ...
                <div class="hotspot hotspot--title__left d-none d-lg-block" style="top: {{ $hotspot->top }}; left: {{ $hotspot->left }};">
                    ...
                    <div class="hotspot--title text-center" style="@if ($hotspot->top < '50%' && $hotspot->left < '50%') top:5%;left:105%; @elseif($hotspot->top < '50%' && $hotspot->left > '50%') top:5%;right:105%; @elseif($hotspot->top > '50%' && $hotspot->left < '50%') bottom:5%;left:105%; @else bottom:5%;right:105%; @endif">
                        ...
                        <a href="https://www.circu.net/products/{{ $hotspot->product->slug }}">
                            @if ($hotspot->product->slug == 'cloud-lamp-big' || $hotspot->product->slug == 'cloud-lamp-small')
                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/carousel/{{ $hotspot->product->slug }}-circu-magical-furniture.gif" width="364" height="380" class="img-fluid hotspot-img">
                            @else
                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/carousel/{{ $hotspot->product->slug }}-circu-magical-furniture.jpg" width="364" height="380" class="img-fluid hotspot-img">
                            @endif
...
@if ($filecount_projects < 1) @else <div class="container-fluid pb-4 d-none d-md-block d-print-none ">
                ...
                <div class="col-12 owl-project owl-carousel owl-slide owl-theme p-0 position-relative ">
                    ...
                    <div class="item">
                        <a href="https://www.circu.net/projects" target="_bank">
                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/projects/{{ $product->slug }}-1.jpg" value="{{ $product->slug }}" class="img-fluid" style="width: 100% !important">
                        </a>
                </div>
    ...
    <div class="col-5-costum p-0 d-print-none ">
        <a href="https://www.circu.net/interior-design-service" target="_blank">
            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/design-and-play.jpg" class="img-fluid" style="width:100%;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:2%;">
            ...
            <a href="https://www.tiktok.com/@circu_magical_furniture" target="_blank">
                <div class="row m-0 align-itens-center" style="height:100%;padding: 0px 0px 0px 1px;">
                    ...
                    <div class="col-1 p-0 position-absolute" style="bottom: 2%;left: 3%;">
                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/btn-play.svg">
                    </div>
    ...
    <div class="col-6 p-0 d-print-none ">
        ...
        <div class="row m-0">
            ...
            <div class="item">
                <a href="https://www.circu.net/projects" target="_bank">
                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/projects/{{ $product->slug }}.jpg" class="img-fluid" style="width: 100% !important">
                </a>
            </div>
            @endif
        </div>
                            ...
                            <div class="col-12 p-0">
                                <div class="row m-0">
                                    <div class="col-12 col-md-8 product_technical p-0 px-3 px-md-0 pl-md-5 pr-md-4">
                                        ...
                                        <div class="product-details__description mb-3">
                                            <h6 class="heading-secondaryr" style="color:#94b7b3 !important;font-size: 13px !important;">DIMENSIONS</h6>
                                            <div class="dimensions-product" style="line-height: 22px;font-size: 13px;letter-spacing: 1px;color: #6c757d;">
                                                {!! $product->product_languages[0]->dimensions !!}</div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-4 product_technical p-0 px-3 px-md-0 pl-md-4 pr-0">
                                        ...
                                        <div class="col-12 col-md-6 text-center p-0">
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg" class="img-fluid human-scale" width="400" height="250" alt="circu human scale">
                                        </div>
                                        @elseif($filecount == 1)
                                        <div class="col-12 col-md-6 text-center p-0">
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg" class="img-fluid" width="400" height="250" alt="circu human scale">
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 col-md-4 product_technical p-0 px-3 px-md-0 pl-md-4 pr-0">
                                        ...
                                        <div class="col-12 col-md-7 text-center p-0">
                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" data-src="/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg" class="img-fluid" width="400" height="250" alt="" srcset="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=">
                                        </div>
                                        @else
                                        @endif
                                    </div>
                            ...
                            <div class="col-12 p-0 px-3 px-md-0">
                                <div class="row m-0 justify-content-center">
                                    ...
                                    <div class="d-none d-xl-block col-xl-3">
                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" data-src="/img/icons/product-page-download-catalogue.jpg" alt="" srcset="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" width="360" height="360" class="img-fluid mt-5">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-12 pt-4 pt-md-2">
                                        <div class="row m-0">
                                            ...
                                            <div class="col-12 col-md-6 p-0 d-none d-md-block">
                                                ...
                                                <div class="row m-0 product-samples-costum">
                                                    ...
                                                    <div class="col-20 text-center p-1 " style="cursor:pointer;">
                                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/finishes/{{ $samples_option->slug }}.png" class="img-fluid img-change" value="{{ $samples_option->slug }}" data-product="{{ $product->slug }}" style="width: 55px;">
                                                ...
                                                <div class="col-12 p-0">
                                                    <div class="row m-0 justify-content-end">
                                                        <div class="col-6 col-lg-4">
                                                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/costumize/{{ $samples_options[0]->slug }}.jpg" class="img-fluid w-100 change-img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12 p-0 pb-3">
                                                <div class="row m-0 justify-content-center">
                                                    <a class="btn btn--primary-grey w-100 talk-with-us" style="max-width: 300px;" href="{{ route('modal-product-price', $product->slug) }}" rel="modal:open" target="_blank"><span>TALK WITH A
                                                            DESIGNER <i class="fas fa-caret-right float-right" style="margin-top:2px;"></i></span></a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="item product-box">
                            <div class="product_thumb py-4">
                                <a href="{{ route('product', ['product' => $similar->product->slug]) }}">
                                    ...
                                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/thumbnails/{{ $similar->product->slug }}-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                                    @else
                                    <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/thumbnails/{{ $similar->product->slug }}-circu-magical-furniture.gif" width="960" height="800" class="img-fluid">
                                    @endif
                                    ...
                                    <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/product-new-collection.png">
                                    </div>
                                    @elseif($similar->product->is_new)
                                    <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                                        <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/icons/product-new.png">
                                    </div>
                                    @endif
                                </a>
    ...
    <div class="container-fluid print-d-none">
        <div class="row pb-2">
            ...
            <div class="col-12 col-md-4 p-0">
                <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=pagproduto&utm_conteudo=circu-springsale23&utm_campanha=springsale">
                    <img alt="Stocklist Spring Sale" src="/img/pag-styles/modern-luxury/banner-side-form-spring-sale.jpg" class="img-fluid w-100">
                </a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var initPhotoSwipeFromDOM = function(gallerySelector) {
                ...
                // custom slide
                $('.trigger-opt-item-size').on('click', function(e) {
                    $(this).addClass("fcurrent_size").siblings().removeClass("fcurrent_size");
                    var existscolors = $('.fcurrent_color img').attr("data-target");
                    console.log(existscolors);
                    if (typeof existscolors === 'undefined') {
                        $search_term = $(e.target).attr("data-target") + '-' + $(e.target).attr("data-target");
                    } else {
                        $search_term = $(e.target).attr("data-target") + '-' + $('.fcurrent_color img').attr("data-target");
                    }

                    // $search_term = $(e.target).attr("data-target") + '-' + $('.fcurrent_color img')
                    //     .attr("data-target");
                    $color_size_avaible_slug = $(".color_size_avaible_" + $(e.target).attr("data-target")).attr("data-target");
                    console.log($search_term);
                    var sliders_custom = document.querySelectorAll(`.slick-slide[data-sample='${$search_term}']`);
                    console.log(sliders_custom);

                    $color_size_avaible = [];
                    $(".color_size_avaible_" + $(e.target).attr("data-target")).each(function() {
                        $color_size_avaible.push($(this).attr("data-target"));
                    });

                    $('.trigger-opt-item').show();
                    if (typeof sliders_custom[0] === 'undefined') {
                        $('.trigger-opt-item').hide();
                        for (i = 0; i < $color_size_avaible.length; ++i) {
                            $('[data-target="' + $color_size_avaible[i] + '"]').parent().show();
                        }
                        $('[data-target="' + $color_size_avaible_slug + '"]').parent().click();
                        $('.fcurrent_color').addClass('notavaible');

                        // dimensions
                        $('.dimensions-product').html($(e.target).attr("data-size-product"));

                        // nome produto
                        if ($(e.target).attr("data-target") == 'standard') {
                            $('.product-details__name').text($(e.target).attr("data-name-product"));
                        } else {
                            $('.product-details__name').text($(e.target).attr("data-name-size"));
                        }
                    } else {
                        $('.trigger-opt-item').hide();
                        for (i = 0; i < $color_size_avaible.length; ++i) {
                        ...
                        $('[data-target="' + $color_size_avaible_slug + '"]').parent().click();
                        $('.fcurrent_color').removeClass('notavaible');
                        ...
                        $('.print-size-color').attr('src', '/img/products/{{ $product->slug }}/details/' + $(e.target).attr("data-target") + '/' + $('.fcurrent_color img').attr("data-target") + '/{{ $product->slug }}-circu-magical-furniture-' + $('.fcurrent_color img').attr("data-target") + '-1.jpg');
                    }
                ...
                $('.trigger-opt-item-size').on('click', function(e) {
                    ...
                    if (typeof sliders_custom[0] === 'undefined') {
                        ...
                        // nome produto
                        if ($(e.target).attr("data-target") == 'standard') {
                            $('.cat-alt').text($(e.target).attr("data-target"));
                        } else {
                            $('.cat-alt').text($(e.target).attr("data-size"));
                        }
                    } else {
                        $('.trigger-opt-item').hide();
                        for (i = 0; i < $color_size_avaible.length; ++i) {
                ...
                $('.trigger-opt-item-drawer').on('click', function(e) {
                    $(this).addClass("fcurrent_drawer").siblings().removeClass("fcurrent_drawer");
                    ...
                    $('.dimensions-product').html($(e.target).attr("data-size-product"))
                    if ($slider_custom_index < 0) {
                        $slider_custom_index = sliders_custom[1].attributes['data-slick-index']
                            .value;
                    }

                    // change human scale
                    if ($(e.target).attr("data-target") == 'standard') {
                        $('.human-scale').attr('src', '/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale.jpg');
                    } else {
                        $('.human-scale').attr('src', '/img/products/{{ $product->slug }}/{{ $product->slug }}-human-scale-' + $('.fcurrent_drawer img').attr("data-target") + '.jpg');
                    }
                    ...
                    if ($(e.target).attr("data-target") == 'standard') {
                        ...
                        $('.product-details__name').text($(e.target).attr("data-name-option"));
                    }
                ...
                $('.trigger-opt-item').on('click', function(e) {
                    $(this).addClass("fcurrent_color").siblings().removeClass("fcurrent_color");
                    var size = $('.fcurrent_size button').attr("data-target");
                    $color_size_avaible_color = [];
                    $(".color_size_avaible_" + size).each(function() {
                        $color_size_avaible_color.push($(this).attr("data-target"));
                    });
                    console.log('click');

                    if (typeof size === 'undefined') {
                        if ($(e.target).attr("data-target") === 'undefined') {
                            $search_term = size + '-' + $color_size_avaible_color[0];
                        } else {
                            $search_term = $(e.target).attr("data-target");
                        }
                        ...
                        $('.print-size-color').attr('src',
                            '/img/products/{{ $product->slug }}/details/' + $(e.target)
                            .attr(
                                "data-target") +
                            '/{{ $product->slug }}-circu-magical-furniture-' + $(e.target)
                            .attr(
                                "data-target") + '-1.jpg');

                    } else {
                        if (typeof $(e.target).attr("data-target") === 'undefined') {
                            $search_term = size + '-' + $color_size_avaible_color[0];
                            console.log($color_size_avaible_color[0]);
                        } else {
                            $search_term = size + '-' + $(e.target).attr("data-target");
                            // console.log($(e.target).attr("data-target"));
                        }
                        // console.log($search_term); ESTOU AQUI
                        ...
                        $('.print-size-color').attr('src',
                            '/img/products/{{ $product->slug }}/details/' + size + '/' + $(e
                    ...
                    console.log($color_size_avaible_color);
                    console.log(sliders_custom);
                    ...
                    if (typeof sliders_custom[0] === 'undefined') {
                        ...
                        $('.fcurrent_color').removeClass('notavaible');
                        $slider_custom_index = sliders_custom[0].attributes['data-slick-index']
                            .value;
            ...
            slickSlide.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide) {
                ...
                $(this).find('.slideCount').html(
                    '<span class="slideCountItem" style="font-weight: normal;font-size:12px;">' +
                    i +
                    '</span> ' + '<span style="font-weight: normal;font-size:12px;">-</span>' +
                    ' <span class="slideCountAll" style="font-weight: normal;font-size:12px;">' +
                    slick
                    .slideCount + '</span>');
            });
    ...
    <script>
        ...
        buttons = document.querySelectorAll(".hotspot--cta");
        buttons.forEach(button => {
            button.addEventListener("click", selectHotspot);
        });
    </script>
