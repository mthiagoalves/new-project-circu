    ...
    <div class="row m-0 p-0">
        <div class="col-12 owl-main owl-carousel owl-slide owl-theme p-0 position-relative d-none d-sm-block">
            <div class="col-12 p-0">
                ...
                <img src="/img/deals/1-banner/special-vouchers-m.jpg" width="550" height="650" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none" style="width:100%;">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-0 px-0 banner-height-2" style=" height: 100%;background-color: #a2c1c6;">
                <img src="/img/deals/50-percent-discount.jpg" width="960" height="800" class="img-fluid">
            </div>
        </div>
        @endif
        @if ($number == 2)
        <!-- <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
                <a href="https://www.circu.net/products/cloud-lamp-small">
                    <div class="product_thumb py-0 px-0 banner-height-2" style="background-image: url(/img/deals/discount-xmas-deals.jpg);background-repeat: no-repeat;background-size: cover;background-position: center;">
                    </div>
                </a>
            </div>  -->
        @endif
...
<div class="container-fluid pt-2">
    <div class="row pb-2">
        <div class="col-12 col-lg-8 p-0 d-block d-lg-none" style="background-color:#dbd2a7;">
            <div class="col-12 col-xl-11 offset-0 offset-xl-1 py-md-1">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 pl-lg-0 text-center px-0">
                        <img src="/img/home/form-magical-kids-bedrooms-and-playground-ideas-m.jpg" width="524" height="264" alt="Magical Kids Bedrooms Circu Kid's Luxury Furniture" class="img-fluid text-center">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4 p-0">
            <a href="https://www.circu.net/ebook/magical-kids-bedrooms-playground-ideas?utm_origem=website&utm_meio=banner-categoria&utm_conteudo=circu-magical-bedrooms-playgrounds&utm_campaign=ourmagicalrooms">
                <img src="/img/pag-styles/modern-luxury/magical-kids-badrooms.jpg" alt="Magical Kids Circu Magical Furniture" class="img-fluid w-100">
            </a>
        </div>
    </div>
</div>
...
<div class="container-fluid my-3" style="background-color:#decfb0; padding:0;">
    <div class="row">
        <div class="col-12 col-xs-12 offset-0 py-0">
            <div class="row">
                <div class="col-12 col-lg-5 offset-xl-1 form-format">
                    @include('includes.middle.form-discount-deals')
                </div>
                <div class="col-12 col-lg-12">
                    <img src="/img/banner-special-vouchers.jpg" alt="Magical Kids Bedrooms and Playground Ideas" class="img-fluid d-none d-sm-block" style="width: 100%; height:300px;">
                    <img src="/img/banner-special-vouchers-m.jpg" width="524" height="264" alt="Magical Kids Bedrooms and Playground Ideas" class="img-fluid d-block d-sm-none">
                </div>
            </div>
        </div>
    </div>
