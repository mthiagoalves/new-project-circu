	...
	<div class="row">
		...
		<div class="col-12 p-0">
			<div class="row grid">
				...
				@endif
				@if ($count < 13)
				<div class="grid-item col-6 col-sm-6 col-md-4 col-lg-3 element-item element-item2 product-box">
			...
			<div class="product_thumb py-4 px-3">
				...
				<div class="product-box--content align-items-end">
					...
					<div class="product-box--share col-12 p-0 pb-5 clearfix">
						<div class="slideToggle">
							<a rel="modal:open" class="btn-green-underline modal-cursor-disable" href="{{ route('modal-product-price', $best_seller->slug) }}"><span>GET
							<b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
						</div>
					</div>
				</div>
