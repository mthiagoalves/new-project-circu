...
<div class="container-fluid">
	<div class="row">
		<div class="col-12 col-md-12 px-lg-5">
			@foreach($projects as $project)
				<div class="col-12 col-md-3 float-left p-1 content-main">
					<div class="col-12 p-0 original-size">
						<a href="#">
							<img src="/img/inspirations/thumbnails/{{$project->slug}}/{{$project->slug}}-thumbnail.jpg" class="img-fluid original-img-size" alt="">
						</a>
						<div class="content-overlay">
							<a href="/inspirations/{{$project->slug}}">
		...
		<div class="col-12 text-center mt-4 mb-2">
			<button class="btn--primary-green load-more">LOAD MORE</button>
		</div>
	</div>
</div>
...
<script type="text/javascript">
 $(document).ready(function() {
      console.log($.ajax);
		...
		$(document).ready(function() {
			var divHeight = $('.original-size').height();
			console.log(`aqui esta ${divHeight}`);
			$('.receive-size').css({'height': divHeight});

			var imgHeight = $('.original-img-size').height();
			$('.receive-img-size').css({'height': imgHeight})
		});
        ...
        function infinteLoadMore(page) {
            $.ajax({
                    url: ENDPOINT + "/inspirations-waiting?page=" + page,
                    datatype: "html",
                    type: "get",
                    beforeSend: function () {
                        $('.auto-load').show();
