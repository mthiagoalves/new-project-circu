...
$product->slug == 'tree-of-numbers-rug'||
$product->slug == 'lewis-armchair'||
$product->slug == 'lotus-sofa'||
$product->slug == 'lewis-chaise-longue'||
$product->slug == 'copper-box'||
$product->slug == 'mowgli-friends-ii-rug')
<div class="container-fluid text-center p-0 swiper-ambients mb-2 d-print-none ">
        ...
        <div class="swiper-wrapper my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
            ...
            <figure class="swiper-slide slider-main find-them-all" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" style="margin-bottom: 0;">
                <a href="/img/products/ambiences/zoom/{{ $article_product->article->slug }}.png" class="link-slides" itemprop="contentUrl" data-size="1679x1108">
                    ...
                    @if($product->slug == 'little-bunny-office-chair' || $product->slug == 'fantasy-air-bookcase-limited-edition' ||  $article_product->article->slug == 'gold-box-3' && $product->slug == 'copper-box' ||  $article_product->article->slug == 'gold-box-3' && $product->slug == 'cotton-candy-II-sofa' ||  $article_product->article->slug == 'meida-bed-1' && $product->slug == 'bubble-gum-desk' ||  $article_product->article->slug == 'meida-bed-1' && $product->slug == 'little-bunny-office-chair' ||  $article_product->article->slug == 'meida-bed-1' && $product->slug == 'bubble-slide')
                    ...
                    @endforeach --}}
                     ...
                     <div class="item">
                        <a href="https://www.circu.net/projects" target="_bank">
                            <img alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/projects/{{ $product->slug }}-1.jpg" value="{{ $product->slug }}" class="img-fluid" style="width: 100% !important">
                        </a>
                </div>
        ...
        <div class="row pb-2">
            ...
            <div class="col-12 col-md-4 p-0">
                <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=pagproduto&utm_conteudo=circu-springsale23&utm_campanha=springsale">
                    <img src="/img/pag-styles/modern-luxury/banner-side-form-spring-sale.jpg" alt="Stocklist Spring Sale" class="img-fluid w-100">
                </a>
            </div>
        </div>
    </div>
