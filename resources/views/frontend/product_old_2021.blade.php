...
@if($product->slug == 'fantasy-air-bookcase-limited-edition' || $product->slug == 'bun-van' || $product->slug == 'little-bunny-chair' || $product->slug == 'animal-stool-bird' || $product->slug == 'animal-stool-shark' || $product->slug == 'puzzled-bookcase-desk' || $product->slug == 'dream-desk' || $product->slug == 'booboo-suspension-sofa' || $product->slug == 'booboo-swing' || $product->slug == 'fantasy-air-balloon' || $product->slug == 'animal-stool-elephant' || $product->slug == 'nodo-suspension-chair' || $product->slug == 'cloud-bed' || $product->slug == 'fantasy-air-nightstand' || $product->slug == 'cloud-nightstand' || $product->slug == 'cloud-lamp-big' || $product->slug == 'cloud-lamp-small' || $product->slug == 'rocky-rocket')
<div class="container-fluid p-0 my-2 d-none d-md-block">
  <div class="row p-0 m-0">
    <div class="col-12 owl-ambients2 owl-carousel owl-slide owl-theme p-0 position-relative">
      ...
      @for($i = 1; $i <= $filecount_best_seller; $i++) <!-- <div class="item col-12 p-0">
...
<div class="container-fluid text-center p-0 swiper-ambients mb-5">
  ...
  <div class="col-12 swiper-container ">
    <div class="swiper-wrapper">
      ...
      @for($i = 1; $i <= $filecount; $i++) <!-- <div class="swiper-slide bigImages d-none d-md-block">
...
<script type="text/javascript">
  ...
  $(window).on('load', function() {
    ...
    var count_item = 0;
    var missed_img = [];
    for (i = 0; i < '{{$filecount_best_seller}}'; i++) {
      var path = 'https://www.circu.net/img/products/{{$product->slug}}/best-seller/slide/desktop/{{$product->slug}}-' + (i + 1) + '.jpg';
      ...
      $("<img/>").attr('src', path).load(function() {
        ...
        if (count_img == 0) {
          ...
          if ($('.item').hasClass('slideitem-' + count_item + '')) {
            count_img = count_img + 6;
          } else {
            $('.owl-ambients2').append('<div class="item col-12 p-0 slideitem-' + count_item + '"></div>');
          }
        }
        if (this.width > this.height) {
          if (count_img != 9) {
            count_img = count_img + 6;
            $('.slideitem-' + count_item).append('<div class="col-6 p-0 px-09 float-left slider-main2" itemscope itemtype="http://schema.org/ImageGallery"> <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample=""><a href="' + this.src.replace("slide/desktop", "zoom").replace("jpg", "png") + '" itemprop="contentUrl" data-size="1679x1108"><img src="' + this.src + '" itemprop="thumbnail" alt="Image description" class="img-fluid" style="width: 100%;"></a></figure></div>');
          } else {
            missed_img.push(this.src);
            console.log(missed_img);

            $('.owl-ambients2').append('<div class="item col-12 p-0 sadasd slideitem-' + (count_item + 1) + '"></div>');
            $('.slideitem-' + (count_item + 1)).append('<div class="col-6 p-0 px-09 float-left slider-main2" itemscope itemtype="http://schema.org/ImageGallery"> <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample=""><a href="' + this.src.replace("slide/desktop", "zoom").replace("jpg", "png") + '" itemprop="contentUrl" data-size="1679x1108"><img src="' + this.src + '" itemprop="thumbnail" alt="Image description" class="img-fluid" style="width: 100%;"></a></figure></div>');
          }
        } else {
          count_img = count_img + 3;
          $('.slideitem-' + count_item).append(' <div class="col-3 p-0 px-09 float-left slider-main2" itemscope itemtype="http://schema.org/ImageGallery"><figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-sample=""><a href="' + this.src.replace("slide/desktop", "zoom").replace("jpg", "png") + '" itemprop="contentUrl" data-size="1679x1108"><img src="' + this.src + '" itemprop="thumbnail" alt="Image description" class="img-fluid" style="width: 100%;"></a></figure></div>');
        }
      });
    }
  });
  ...
  $(document).ready(function() {
    ...
    $(window).on('load', function() {
      setTimeout(function() {
        ...
        initPhotoSwipeFromDOM('.slider-main2');
      }, 1000);
    });
