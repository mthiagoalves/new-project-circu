...
<div class="container-fluid my-3">
    ...
    <div class="row">
        <div class="col-12 col-xl-10 offset-xl-1">
            <div class="row">
                <div class="col-12 col-lg-6 product-slide text-center d-none d-lg-block" style="background-image: url(/img/pricelist/pricelist-circu-magical-furniture.jpg);background-position: center center;background-size: cover;">
                </div>
                <div class="col-12 col-lg-6 pb-3 p-0 product-slide text-center d-block d-lg-none">
                    <img src="/img/pricelist/pricelist-circu-magical-furniture-m.jpg" class="img-fluid">
                </div>
                <div class="col-12 col-lg-6 pl-4 product-details">
                        ...
                        <div class="col-12">
                            ...
                            <div class="product-details__intro clearfix col mb-2 p-0">
                                <div class="float-left">
                                    <h1 class="product-details__name">PRICELIST CIRCU 2022</h1>
                                </div>

                            </div><!-- product-details__intro -->
                            <div class="product-details__description mb-3">
                                <div class="col col-xl-12 text-justify p-0">
                                    <p>Fill in the information below to have exclusive access to our Pricelist. Our magical team will contact you, as soon as possible, and present to you the special conditions and campaigns we have at the moment.</p>
                                </div>
                            </div>
                            <form method="post" class="col-xl-12  p-0 form-popup form-parsley open-form-vt" action="{{ route('process.pricelist') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('first_name') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('last_name') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('occupation') ? 'has-error' : '' }} open-form">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('company') ? 'has-error' : '' }} open-form">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('country') ? 'has-error' : '' }} open-form">
                                    ...
                                    <div class="col-sm-6">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('city') ? 'has-error' : '' }} open-form">
                                    ...
                                    <div class="col-sm-12">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('state') ? 'has-error' : '' }} d-none state-ebook open-form">
                                    ...
                                    <div class="col-sm-12">
                                        <div style="margin: 0px 0px 12px !important;" class="input-block {{ $errors->has('hear_about') ? 'has-error' : '' }} open-form">
                                    ...
                                    <div class="col-12 mb-3 open-form">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" id="request-price-tag" class="btn-request-piece" style="color: #FFFFFF;font-size: 0.75rem;letter-spacing: 0.1rem;font-weight: bold;border: 1px solid transparent;padding: .375rem 1.75rem;">REQUEST PRICELIST <i class="fas fa-caret-right"></i></button>
                                    </div>
...
<div class="container-fluid py-2">
            ...
            <div class="product_thumb py-4">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable" href="{{route('modal-product-price', $product1->slug )}}"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
    ...
    <div class="col-12 slideToggle text-center mt-2">
        <a class="btn-get-price py-2 px-4" href="https://www.circu.net/products"><span>SEE <b>ALL PRODUCTS</b> &gt;</span> </a>
    </div>
</div>
<div class="container-fluid py-2">
