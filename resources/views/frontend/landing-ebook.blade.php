		...
		<div class="col-12 col-xl-10 offset-xl-1">
			<div class="row">
				<div class="col-12 col-lg-6 product-slide text-center">
					@if($ebook->slug == 'stocklist-spring-sale' || $ebook->slug == 'new-products-2023' || $ebook->slug == 'stocklist-annual-sale' || $ebook->slug == 'catalogue-circu-magical-furniture' || $ebook->slug == 'summer-sale' || $ebook->slug == '100-luxury-kids-rooms' || $ebook->slug == 'magical-kids-bedrooms-playground-ideas' || $ebook->slug == 'brochura-best-sellers' || $ebook->slug == 'coveted-magazine-23nd-edition')
			...
			<div class="product_thumb py-2 px-3">
				...
				<div class="col-12 clearfix position-relative mt-3 p-0">
					<div class="slideToggle">
						<a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable" href="{{route('modal-product-price', ['name' => $best_seller->slug] )}}"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
					</div>
				</div>
				<div class="product-box--content align-items-end">
					...
					<div class="product-box--share col-12 clearfix">
						<div class="slideToggle">
							<a rel="modal:open" class="btn-green-underline" href="{{route('modal-product-price', ['name' => $best_seller->slug] )}}"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
						</div>
					</div>
				</div>
			</div>
