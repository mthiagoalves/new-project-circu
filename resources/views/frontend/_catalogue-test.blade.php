...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 text-center filters mt-5" id="initial">
...
<div class="container max-width-site">
  <div class="row">
    ...
    <div class="grid col-12 p-0 d-flex">
      <div class="col-12 col-sm-6 col-xl-3 grid-sizer float-left d-none"></div>
      ...
      @endphp
      @if ($count < 5) 
      <div class="col-12 col-sm-6 col-xl-3 grid-item element-item text-center p-2 product-box {{$ebook->key_words}}">
        ...
        <div class="row">
          <div class="col-12 d-flex justify-content-center">
            ...
            <label for="{{$ebook->slug}}" class="checkbox-custom"> </label>
    ...
    <div id="demo-stock" class="row col-12 m-0 p-0  collapse">
      @endif
      <div class="col-12 col-sm-6 col-xl-3 element-item grid-item text-center p-2 product-box {{$ebook->key_words}}">
        <a href="{{ route('landing-ebook', ['ebook' => $ebook->slug]) }}">
          <img src="/img/landing/download-catalogue/{{$ebook->slug}}.jpg" width="540" height="422" class="img-fluid py-3" alt="">
          <div class="product--title mt-2">
            <span class="name">{{$ebook->article_languages[0]->title}}</span>
...
<div class="row mt-4 mb-3">
  <div class="col-12 d-flex justify-content-center load-more">
    <a href="#initial" data-toggle="collapse" data-target="#demo-stock">
      <span class="btn btn--ebook newButton">VIEW MORE</span>
    </a>
  </div>
</div>
</div>
