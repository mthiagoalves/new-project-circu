...
<div class="container-fluid mb-3">
    ...
    <div class="row">
        ...
        <script>
            document.title = 'Beds | Circu Magical Furniture - Luxury brand for children'

            document
                .getElementsByTagName('meta')
                .namedItem('keywords')
                .setAttribute('content', 'kids beds, toddler bed, kids bed, toddler beds, girls bed, childrens beds, boys bed, bunk bed, bunk beds, bunk beds for kids, bed, bed time, luxury bed, luxury beds, magical furniture, kids bedroom ideas, kids decor ideas, children decor ideas, childrens room, kids room furniture, kids room decoration, kids room design, children bedroom, kids room interior design, kids room inspiration, kids room decor ideas, design for kids, kids luxury brand');
        
                document
                .getElementsByTagName('meta')
                .namedItem('description')
                .setAttribute('content', 'Explore The Most Comfortable Pieces For Your Kids Room: Unique Beds, Cradles and Cribs to allow children to dream their own dreams! ');
        </script>

        <!-- SLIDE DESKTOP -->
        <div class="col-12 owl-main owl-carousel owl-slide owl-theme p-0 position-relative">
            <div class="col-12 p-0">
                <a href="https://www.circu.net/circu-new-showroom?utm_origem=website&utm_meio=topbanner-categoria&utm_conteudo=circu-newshowroom&utm_campanha=showroom">
                    <img src="/img/slides/main/banner-homepage-showroom.jpg" alt="New Showroom circu magical furniture" class="img-fluid w-100 d-none d-md-block">
                    <img src="/img/slides/main/banner-homepage-showroom-m.jpg" alt="New Showroom circu magical furniture" class="img-fluid w-100 d-block d-md-none">
                </a>
            </div>
            <div class="col-12 p-0">
        ...
        <script>
            document.title = 'Lighting | Circu Magical Furniture - Luxury brand for children'

            document
                .getElementsByTagName('meta')
                .namedItem('keywords')
                .setAttribute('content', 'kids lighting, unique kids lighting, fun kids lighting, new kids lighting, kids lighting for bedroom, kids lighting fixture, kids lighting ideas, modern kids lighting, kids lighting wall sconce, kids lighting fixtures, cool kids lighting, top kids lighting,  children lighting, children lighting fixtures, children lamp, suspension Lamps, wall lamps,  table lamps, suspension light,  suspension lighting, wall light, wall lighting,  table lighting, table light');
        
                document
                .getElementsByTagName('meta')
                .namedItem('description')
                .setAttribute('content', "Brighten Up The Kids' Room With Children's Lighting: Suspension Lamps, Wall Lamps, Table Lamps & More.");
        </script>
        ...
        <script>
            document.title = 'Seating | Circu Magical Furniture - Luxury brand for children';

            document
                .getElementsByTagName('meta')
                .namedItem('description')
                .setAttribute('content', 'Explore The Most Comfortable Pieces For Your Kids Space: Sofas, Armchairs,  Stools, Office Chairs, Chaise-Longue Sofas, Chairs, Benchs and Rocking Chairs.');

            document
                .getElementsByTagName('meta')
                .namedItem('keywords')
                .setAttribute('content', 'Sofas, Armchairs, Stools, chair, chaise longue, bench, office chair, kids sofa, kids chair, rocking chair, ottoman, magical furniture, kids bedroom ideas, kids decor ideas, children decor ideas, childrens room, kids room furniture, kids room decoration, kids room design, children bedroom, kids room interior design, kids room inspiration, kids room decor ideas, design for kids, kids luxury brand ');
        </script>
        <!-- SLIDE DESKTOP -->
        ...
        <script>
            document.title = 'Play & Learn | Circu Magical Furniture - Luxury brand for children'

            document
                .getElementsByTagName('meta')
                .namedItem('keywords')
                .setAttribute('content', 'playground, kids playground, indoor playground, playground set, playground indoor, childrens playground, gym, kids gym, little kids gym, indoor kids gym, kids gym set, monkey bars,  desk, kids desk, modern kids desk, kids desk with storage, best kids desk, kids desk tables, kids desk area, kids desk decor, kids desk design, dressing table, dressing table with mirror, dressing table mirror, vanity dressing table, modern dressing table, dressing table designs, dressing table design, dressing table kids, kids dressing table, table, kids table, round kids table, modern kids table');
        
                document
                .getElementsByTagName('meta')
                .namedItem('description')
                .setAttribute('content', 'Discover the most exclusive and unique pieces for your kids playrooms and study rooms with Circu Magical Furniture: playgrounds, gyms, tables, desks, dressing tables and more.');
        </script>
        ...
        <script>
            document.title = 'Storage  | Circu Magical Furniture - Luxury brand for children'

            document
                .getElementsByTagName('meta')
                .namedItem('keywords')
                .setAttribute('content', 'kids storage, kids storage ideas, kids storage furniture, luxury kids storage, modern kids storage, kids storage design, nightstand, kids nightstand, creative kids nightstand, modern kids nightstand, best kids nightstand, high quality kids nightstand, kids nightstand furniture, kids nightstand design, kids nightstand blue, kids nightstand pink,  kids bookcase, bookcase, desk, kids desk, modern kids desk, kids desk with storage, best kids desk, kids desk tables, kids desk area, kids desk decor, kids desk design, shelf, kids shelf, kids chest of drawers, bookshelf, toy box, kids toy box, cabinet, kids cabinet');
        
                document
                .getElementsByTagName('meta')
                .namedItem('description')
                .setAttribute('content', 'Find the most exclusive and unique storage pieces for kids rooms with Circu Magical Furniture: Nightstands, Chest of  Drawers, Bookcases, Shelves, Desks, Bookshelves, Toy Boxes, Cabinets and More.');
        </script>
        @elseif($key == 'hardware')
        <!-- SLIDE DESKTOP -->
        ...
        <div class="d-none d-lg-block col-lg-3 product-box has-overlay" style="background-image:url('/img/products/blank-spaces/small-fantasy-air-balloon-lounge-circu-magical-furniture.jpg');background-position:center 80%;background-size:cover;cursor:pointer;" onclick='window.location.href="https://www.circu.net/products/fantasy-air-balloon-lounge"'>
            <div class="position-absolute" style="bottom:7%;left:2%;text-align:center;color:#FFFFFF;font-size:1.1rem;font-weight:bold;letter-spacing: 1px;">
                FANTASY AIR BALLON LOUNGE | <span style="font-size:0.9rem;">SEE MORE ></span></div>
        </div>
        <div class="col-12 slideToggle text-center my-3">
            <a class="btn-get-price py-2 px-4" href="{{ route('products') }}"><span>SEE <b>ALL
                        PRODUCTS</b> &gt;</span> </a>
        ...
        <div class="container-fluid pt-2">
            <div class="row pb-2">
                <div class="col-12 col-lg-8 p-0 d-block d-lg-none" style="background-color:#decfb0;">
                    <div class="col-12 col-xl-11 offset-0 offset-xl-1 py-md-1">
                        <div class="row">
                            <div class="col-12 col-lg-6 p-lg-0">
                            ...
                            <div class="col-12 col-lg-6 pl-lg-0 text-center px-0">
                                <a href="https://www.circu.net/ebook/magical-kids-bedrooms-playground-ideas?utm_origem=website&utm_meio=topbanner-newproducts&utm_conteudo=circu-magical-bedrooms-playgrounds&utm_campaign=ourmagicalrooms">
                ...
                <div class="col-12 col-lg-8 p-0 d-none d-lg-block">
                    <div class="col-12 p-0">
                        <a href="https://www.circu.net/ebook/new-products-2023?utm_origem=website&utm_meio=banner-categoria&utm_conteudo=circu-newproducts-23&utm_campanha=newproducts">
                            <img src="/img/home/new-products-banner-form.jpg" alt="New Products 2023 Circu Kid's Luxury Furniture" style="width:100%;" class="img-fluid d-none d-lg-block">
                        </a>
                    </div>
                    <div class="col-12 col-lg-6 pr-lg-0 position-absolute form-catlogue-r" style="top: 50%;left: 2%;">
                        @include('includes.middle.form-ebook-new')
    ...
    @endif -->
        ...
        <div class="d-none d-lg-block col-lg-6 product-box has-overlay" style="background-image:url('/img/products/blank-spaces/medium-cloud-lamp-big-circu-magical-furniture.jpg');background-position:center 35%;background-size:cover;cursor:pointer;" onclick='window.location.href="https://www.circu.net/products/cloud-lamp-big"'>
            <div class="position-absolute" style="bottom:7%;left:2%;text-align:center;color:#FFFFFF;font-size:1.1rem;font-weight:bold;letter-spacing: 1px;">
                CLOUD LAMP BIG |<span style="font-size:0.9rem;">SEE MORE ></span></div>
        </div>
        <div class="col-12 slideToggle text-center my-3">
            <a class="btn-get-price py-2 px-4" href="{{ route('products') }}"><span>SEE <b>ALL
                        PRODUCTS</b> &gt;</span> </a>
        ...
        <div class="d-none d-lg-block col-lg-6 product-box has-overlay" style="background-image:url('/img/products/blank-spaces/medium-bubble-gum-3-drawers-circu-magical-furniture.jpg');background-position:center bottom;background-size:cover;cursor:pointer;" onclick='window.location.href="https://www.circu.net/products/bubble-gum-chest-3-drawers"'>
            <div class="position-absolute" style="bottom:3%;left:2%;text-align:center;color:#FFFFFF;font-size:1.1rem;font-weight:bold;letter-spacing: 1px;">
                BUBBLE GUM 3 DRAWERS | <span style="font-size:0.9rem;">SEE MORE ></span></div>
        </div>
        <div class="col-12 slideToggle text-center my-3">
            <a class="btn-get-price py-2 px-4" href="{{ route('products') }}"><span>SEE <b>ALL
                        PRODUCTS</b> &gt;</span> </a>
                ...
                <div class="col-12 col-lg-8 p-0 d-block d-lg-none" style="background-color:#98b0c8;">
                    <div class="col-12 col-xl-11 offset-0 offset-xl-1 py-md-1">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 pl-lg-0 text-center px-0">
                                <img src="/img/stocklist-annual-sale-form-banner-m.jpg" width="524" height="264" alt="Magical Kids Bedrooms Circu Kid's Luxury Furniture" class="img-fluid text-center">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-8 p-0 d-none d-lg-block">
                    <div class="col-12 p-0">
                        <a href="https://www.circu.net/stocklist?utm_origem=website&utm_meio=banner-categoria&utm_conteudo=circu-annual-sale-22&utm_campanha=annualsales">
                            <img src="/img/home/stocklist-annual-sale-form-banner.jpg" alt="Catalogue Circu Kid's Luxury Furniture" style="width:100%;" class="img-fluid d-none d-lg-block">
                        </a>
                    </div>
                    <div class="col-12 col-lg-6 pr-lg-0 position-absolute form-catlogue-r" style="top: 50%;left: 2%;">
                        @include('includes.middle.form-stocklist-annual-sale')
