                ...
                <div class="col-12 owl-project owl-carousel owl-slide owl-theme p-0 position-relative ">
                    ...
                    @for ($i = 1; $i <= $filecount_projects; $i++) <div class="item">
                        <a href="https://www.circu.net/projects" target="_bank">
                            <img draggable="false" alt="{{ $product->name }} circu magical furniture kids {{ $product->sub_category->category->category_languages[0]->name }}" src="/img/products/{{ $product->slug }}/projects/{{ $product->slug }}-{{ $i }}.jpg" value="{{ $product->slug }}" class="img-fluid" style="width: 100% !important">
                        </a>
                </div>
                @endfor
        ...
        <div class="row pb-2">
            ...
            <div class="col-12 col-md-4 p-0">
                <a href="https://www.circu.net/circu-new-showroom?utm_origem=website&utm_meio=pagproduto&utm_conteudo=circu-newshowroom&utm_campanha=showroom">
                    <img alt="New Showroom Circu" src="/img/form-imgs/banner-side-form-new-showroom.jpg" class="img-fluid w-100">
                </a>
            </div>
        </div>
    </div>
