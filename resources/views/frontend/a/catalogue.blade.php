...
<div class="container-fluid p-0">
	<div class="row m-0">
		...
		<div class="col-12 col-xl-10 offset-xl-1">
			<div class="row">
				<div class="col-12 col-lg-6 product-slide text-center">
					...
					<img src="/img/landing/download-catalogue/magical-rooms-circu-magical-furniture.jpg" class="img-fluid">
				</div>
				<!-- issuu code -->
						...
						<div class="col-12">
							<div class="product-details__intro clearfix col mb-3 p-0">
								<div class="float-left">
									<h1 class="product-details__name">MAGICAL KIDS BEDROOMS AND PLAYGROUND IDEAS</h1>
							...
							<!-- <div class="product-details__description mb-3">
								<div class="col col-xl-10 text-justify p-0">
								  <p>CIRCU was built under a dream! The dream is to allow children to live their own fantasies and adventures in a magical world of their own.</p>
								  <p>In our newest catalog, you will find the most recent and magical products, that will allow you to create spaces where dreams come true. From a Hot Air balloon bed, a rocket armchair to an airplane bed, with CIRCU you will find the most creative solutions for a one of kind project. </p>
								  <p>We aim to be the pinnacle of fun, freedom, and life, introducing a new entire world where anything is possible. </p>
								
								  <p style="color:#8bb9b6;">Download now our new catalog and be prepare to discover a world where anything is possible! </p>
								</div>
								</div> -->
							<!-- product-details__description -->
							<!-- <div class="product-details__actions mb-3 print-d-none">
								<div class="block">
								  <a rel="modal:open" class="btn btn--primary-green w-50 mb-1" href="{{route('modal-ebook', ['ebook' => 'catalogue-circu-magical-furniture'] )}}"><span>DOWNLOAD NOW <i class="fas fa-caret-right"></i></span></a>
								</div>
		...
		<div class="col-12 p-0 owl-main owl-carousel owl-slide owl-theme p-0 position-relative">
			<div class="item">
				<a href="https://www.circu.net/circu-new-showroom?utm_origem=website&utm_meio=headbanner-cataloguesandbooks&utm_conteudo=circu-newnewshowroom&utm_campanha=showroom">
				<img src="/img/slides/main/banner-homepage-showroom.jpg" width="1920" height="800" alt="New Products 2023" class="cd-dot img-fluid d-none d-md-block" style="width:100% !important;">
				<img src="/img/slides/main/banner-homepage-showroom-m.jpg" width="1920" height="800" alt="New Products 2023" class="cd-dot img-fluid d-block d-md-none" style="width:100% !important;">
				</a>
			</div>
		</div>
	</div>
