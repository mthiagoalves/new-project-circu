...
@section('main-content')
    <div class="container-fluid p-0">
            ...
            <div class="col-12 p-0">
                ...
                <div class="col-12 pt-4 text-center position-absolute" style="flex-basis: auto;cursor: pointer;bottom:3%;">
                    ...
                    <p class="subtitle text-center mb-0 text-uppercase" style="font-size: 0.95rem;color:#fff;">
                        <b>Salone del Mobile Milano 2022</b>
                    </p>
                </div>
        ...
        <div class="row m-0 justify-content-center my-5">
            <div class="col-12 col-md-5 text-center">
                <p style="font-size: 14px; color: #666 !important;">CIRCU arrived at Milan with the dream to allow children to live their own fantasies and create their magical world and presented our new amazing pieces at <b>Salone del Mobile Milano 2022</b>. Hope you enjoyed our stand and see you next year! But if you didn't have the opportunity to visit live our stand, check our <b> Tour Experience</b>!
                </p>
            </div>
        </div>
        <div class="row m-0 justify-content-center mb-5 mt-0">
            <div class="col-12 col-md-5 text-center">
                <a rel="modal:open" href="https://www.circu.net/includes/modal-download-ebooks/new-products-2022" style="font-size: 12px; letter-spacing: 1px; padding: 5px 26px 4px; margin: 0px 10px; z-index: 2; background-color: #98b9b5; color: #FFFFFF; border: 1px solid #98b9b5; display: inline-block;">DOWNLOAD EBOOK</a>
                      ...
                      <div class="col-12 p-0 div-text-banner-center-paddings">
                        ...
                        <div class="col-12 p-0">
                          <p class="text-2-title">CIRCU was built under a dream! The dream is to allow children to live their own fantasies and create a magical world for them to fly under an imagination that has no limit and we will bring ou magical world to this year Salone del Mobile! Discover hundreds of magical new products through a virtual tour of our stand in Milano.<br class="d-none d-md-block"> 
                            You can't buy happiness but you can buy CIRCU, that's kind of the same thing! Visit now for yourself or book a virtual meeting to know more about ongoing campaigns.</p>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="container-fluid py-2">
        ...
        <div class="row grid-showcase">
            <?php $number = 0; ?>
            @foreach ($products_showcase as $showcase)
                <?php $number++; ?>
                @if ($number < 9)
                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 product-box element-item element-item-showcase">
                        <div class="product_thumb py-4">
                            <a href="{{ route('product', ['product' => $showcase->slug]) }}">
                                @if (file_exists('./img/products/thumbnails/' . $showcase->slug . '-circu-magical-furniture.png'))
                                    <img src="/img/products/thumbnails/{{ $showcase->slug }}-circu-magical-furniture.png"
                                        width="960" height="800" class="img-fluid">
                                @else
                                    <img src="/img/products/thumbnails/{{ $showcase->slug }}-circu-magical-furniture.gif"
                                        width="960" height="800" class="img-fluid">
                                @endif
                                ...
                                <div class="product--title">
                                    ...
                                    <span
                                        class="sub_category">{{ ucwords($showcase->sub_category->sub_category_languages[0]->name) }}</span>
                                </div>
                            </a>
                            <div class="col-12 clearfix position-relative mt-1 p-0">
                                <div class="slideToggle">
                                    <a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable"
                                        href="{{ route('modal-product-price', ['name' => $showcase->slug]) }}"><span>GET
                                            <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                                </div>
                            </div>

                            @if (($showcase->is_new && $showcase->slug == 'bubble-gum-bed') || $showcase->slug == 'bubble-gum-bench' || $showcase->slug == 'bubble-gum-dressing-table' || $showcase->slug == 'bubble-gum-chest-3-drawers' || $showcase->slug == 'bubble-gum-chest-2-drawers' || $showcase->slug == 'bubble-gum-desk' || $showcase->slug == 'bubble-slide' || $showcase->slug == 'bubble-loop' || $showcase->slug == 'bubble-drop' || $showcase->slug == 'bubble-gum-playground' || $showcase->slug == 'bubble-gum-big-mirror' || $showcase->slug == 'bubble-gum-small-mirror' || $showcase->slug == 'cotton-candy-sofa' || $showcase->slug == 'rainbow-sofa')
                                <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                                    <img src="/img/icons/product-new-collection.png">
                                </div>
                            @elseif($showcase->is_new)
                                <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                            ...
                            <div class="product-box--content d-none d-md-block">
                                @if ($showcase->product_samples->count() > 1 && $showcase->slug != 'dainty-armchair')
                                    <div class="col-12 slider-for text-center">
                                        @foreach ($showcase->product_samples as $product_sample)
                                            <div>
                                                <a href="{{ route('product', ['product' => $showcase->slug]) }}">
                                                    <img src="/img/products/{{ $showcase->slug }}/finishes/{{ $showcase->slug }}-circu-magical-furniture-{{ $product_sample->sample->slug }}.png"
                                ...
                                @else
                                    <div>
                                        <a href="{{ route('product', ['product' => $showcase->slug]) }}">
                                            <img src="/img/products/thumbnails-covers/{{ $showcase->slug }}-circu-magical-furniture.jpg"
    ...
    <div class="container-fluid pt-4 pb-2">
        ...
        <div class="row grid-new">
            <?php $number = 0; ?>
            @foreach ($products_newproducts as $newproduct1)
                <?php $number++; ?>
                @if ($number < 9)
                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 product-box element-item element-item-new">
                        <div class="product_thumb py-4">
                            <a href="{{ route('product', ['product' => $newproduct1->slug]) }}">
                                @if (file_exists('./img/products/thumbnails/' . $newproduct1->slug . '-circu-magical-furniture.png'))
                                    <img src="/img/products/thumbnails/{{ $newproduct1->slug }}-circu-magical-furniture.png"
                                        width="960" height="800" class="img-fluid">
                                @else
                                    <img src="/img/products/thumbnails/{{ $newproduct1->slug }}-circu-magical-furniture.gif"
                                        width="960" height="800" class="img-fluid">
                                @endif

                                <div class="product--title">
                                    <span class="name">{{ $newproduct1->name }}</span>
                                    <br class="d-block d-md-none">
                                    <span
                                        class="sub_category">{{ ucwords($newproduct1->sub_category->sub_category_languages[0]->name) }}</span>
                                </div>
                            </a>
                            <div class="col-12 clearfix position-relative mt-1 p-0">
                                <div class="slideToggle">
                                    <a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable"
                                        href="{{ route('modal-product-price', ['name' => $newproduct1->slug]) }}"><span>GET
                                            <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                                </div>
                            </div>

                            @if (($newproduct1->is_new && $newproduct1->slug == 'bubble-gum-bed') || $newproduct1->slug == 'bubble-gum-bench' || $newproduct1->slug == 'bubble-gum-dressing-table' || $newproduct1->slug == 'bubble-gum-chest-3-drawers' || $newproduct1->slug == 'bubble-gum-chest-2-drawers' || $newproduct1->slug == 'bubble-gum-desk' || $newproduct1->slug == 'bubble-slide' || $newproduct1->slug == 'bubble-loop' || $newproduct1->slug == 'bubble-drop' || $newproduct1->slug == 'bubble-gum-playground' || $newproduct1->slug == 'bubble-gum-big-mirror' || $newproduct1->slug == 'bubble-gum-small-mirror' || $newproduct1->slug == 'cotton-candy-sofa' || $newproduct1->slug == 'rainbow-sofa')
                                <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                                    <img src="/img/icons/product-new-collection.png">
                                </div>
                            @elseif($newproduct1->is_new)
                                <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
                                    <img src="/img/icons/product-new.png">
                                </div>
                            @endif
                            ...
                            <div class="product-box--content d-none d-md-block">
                                @if ($newproduct1->product_samples->count() > 1 && $newproduct1->slug != 'dainty-armchair')
                                    <div class="col-12 slider-for text-center">
                                        @foreach ($newproduct1->product_samples as $product_sample)
                                            <div>
                                                <a href="{{ route('product', ['product' => $newproduct1->slug]) }}">
                                                    <img src="/img/products/{{ $newproduct1->slug }}/finishes/{{ $newproduct1->slug }}-circu-magical-furniture-{{ $product_sample->sample->slug }}.png"
                                                        width="960" height="800" alt="" class="img-fluid">
                                                </a>
                                            </div>
                                        @endforeach
                                ...
                                @else
                                    <div>
                                        <a href="{{ route('product', ['product' => $newproduct1->slug]) }}">
                                            <img src="/img/products/thumbnails-covers/{{ $newproduct1->slug }}-circu-magical-furniture.jpg"
                                                width="500" height="420" alt="" class="img-fluid">
                                        </a>
                                    </div>
                                @endif
                ...
                <div class="col-12 p-0">
                    <div class="row m-0">
                        <div class="col-12 col-md-6">
                            <div class="col-12 p-0">
                                <a href="https://www.kidsbedroomideas.eu/isaloni-2022-guide-luxury-interior-design-event/"
                                    target="_blank">
                            ...
                            <div class="col-12 text-center">
                                <p class="py-3" style="font-size: 1rem;font-weight: 600;margin: 0;">iSaloni 2022:
                                    Guide To This Luxury Interior Design Event
                                </p>
                                <a href="https://www.kidsbedroomideas.eu/isaloni-2022-guide-luxury-interior-design-event/"
                        ...
                        <div class="col-12 col-md-6 pt-5 pt-md-0">
                            <div class="col-12 p-0">
                                <a href="https://www.kidsbedroomideas.eu/isaloni-2022-milan-city-guide/" target="_blank">
    ...
    <div class="container-fluid p-0">
        <div class="row m-0 pb-2">
            <div class="col-12 col-md-4 p-0">
                <a
                    href="https://www.circu.net/ebook/new-products-2022/?utm_origem=website&amp;utm_meio=2nslide&amp;utm_conteudo=circu-new-products-2.0-página-individual-prod&amp;utm_campanha=newproducts22">
                    <img alt="Periwinkle circu magical furniture kids lighting" src="/img/home/banner-new-products-2022.gif"
...
@section('footer-includes')
    ...
    <script>
        ...
        $(".new-procuct.collapse").on('shown.bs.collapse', function() {
            ...
            $('.element-item-new .slider-for').each(function(num, elem) {
                elem = $(elem);
                ...
                elem.slick({
                    ...
                    fade: true,
                    accessibility: false,
                    asNavFor: '.element-item-new .slider-nav'
                });

                elem.next('.element-item-new .slider-nav').slick({
                    slidesToShow: 7,
                    slidesToScroll: 1,
                    asNavFor: '.element-item-new .slider-for',
                    variableWidth: true,
                    dots: false,
                    centerMode: true,
                    arrows: false,
            ...
            $('.element-item-new .slider-nav .slick-slide').on('click', function(event) {
                $('.element-item-new .slider-for').slick('slickGoTo', $(this).data('slickIndex'));
            });

            var elm = $('.element-item-new .slider-nav '),
