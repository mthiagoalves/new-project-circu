	...
	<div class="row">
		...
		<div class="col-12 owl-main owl-carousel owl-slide owl-theme nopadding position-relative d-block d-sm-none">
			...
			<div class="item">
				...
				<img src="/img/slides/main/stocklist-annual-sale-m-new.jpg" width="1920" height="800" alt="Summer Sale Stocklist Circu Magical Furniture" class="cd-dot img-fluid" style="width:100% !important;">
				</a>
			</div>
			<div class="item">
				...
				<img src="/img/slides/main/summer-sale-mobile-new.jpg" width="552" height="432" alt="Summer Sale Stocklist Circu Magical Furniture" class="cd-dot img-fluid">
				</a>
			</div>
			<div class="item">
				<a href="{{ route('our-houses-new') }}">
...
<div class="container-fluid pt-2">
	...
	<div class="row py-2">
		<div class="col-12 col-lg-3" style="padding: 0 0 0.25rem 0">
			<a href="https://www.circu.net/inspirations/category/interior-design/boys-room/" target="_blank">
				<img src="/img/icons/menu-projects/boys-room-circu-magical-furniture-m.jpg" alt="Shop Boy Circu Magical Furniture" class="img-fluid w-100 d-block d-lg-none">
				<img src="/img/icons/menu-projects/shop-boy-circu-magical-furniture.jpg" alt="Shop Boy Circu Magical Furniture" class="img-fluid w-100 d-none d-lg-block">
		...
		<div class="col-12 col-lg-3 " style="padding: 0 0 0.25rem 0">
			<a href="https://www.circu.net/inspirations/category/interior-design/girls-room/" target="_blank">
				<img src="/img/icons/menu-projects/girls-room-circu-magical-furniture-m.jpg" alt="Shop Girl Circu Magical Furniture" class="img-fluid w-100 d-block d-lg-none">
				<img src="/img/icons/menu-projects/shop-girl-circu-magical-furniture.jpg" alt="Shop Girl Circu Magical Furniture" class="img-fluid w-100 d-none d-lg-block">
				<div class="menu-project-item">
					<span class="homepage-shop">SHOP</span>
		...
		<div class="col-6 col-lg-3 p-0">
			<div class="col-12 owl-projects-slide owl-carousel owl-slide owl-theme nopadding position-relative">
				<div class="item">
					...
					<img src="/img/icons/menu-projects/projects-circu-magical-furniture.jpg" alt="Projects Circu Magical Furniture" class="img-fluid w-100">
					</a>
				</div>
				<div class="item">
	...
	<div class="row pb-2">
		...
		<div class="col-12 col-lg-4 p-0">
			<a href="https://www.circu.net/circu-new-showroom?utm_origem=website&utm_meio=2nslide&utm_conteudo=circu-newshowroom&utm_campanha=showroom">
