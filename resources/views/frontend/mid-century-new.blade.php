...
<div class="container-fluid pb-2" id="main-slide">
    <div class="row">
        ...
        <div class="col-12 owl-main owl-carousel owl-slide owl-theme p-0 position-relative d-none d-sm-block">
            <div class="item">
                <img src="/img/pag-styles/mid-century/banner-d.jpg" alt="Circu Magical World" class="cd-dot img-fluid" style="width:100% !important;">
            </div>

            <div class="item">
                <a href="{{route('new-products')}}">
                    <img src="/img/slides/main/new-products-collection.jpg" alt="New Products Collection" class="cd-dot img-fluid" style="width:100% !important;">
                </a>
            </div>
        </div>
        ...
        <div class="col-12 owl-main owl-carousel owl-slide owl-theme nopadding position-relative d-block d-sm-none">
            <div class="item">
                <img src="/img/pag-styles/mid-century/banner-m.jpg" alt="Circu Magical World" class="cd-dot img-fluid" style="width:100% !important;">
            </div>
            <div class="item">
                <a href="{{route('new-products')}}">
                    <img src="/img/slides/main/new-products-collection-mobile.jpg" alt="New Products Collection" class="cd-dot img-fluid" style="width:100% !important;">
                </a>
            </div>
        </div>
...
<style>
    ...
    .hotspot--bubble-gum-gym {
        top: 60%;
        right: 35%;
    }
    
    .hotspot--bubble-gum-gym .hotspot--title {
        bottom: -15%;
        right: 105%;
    }
    
    .hotspot--bubble-gum-gym-mobile {
        top: 60%;
        right: 35%;
    }
    
    .hotspot--rocky-rocket {
        top: 68%;
        left: 20%;
    }
    
    .hotspot--rocky-rocket .hotspot--title {
        bottom: -15%;
        left: 105%;
    }
    
    .hotspot--rocky-rocket-mobile {
        top: 63%;
        left: 10%;
    }
    /* fim slide1 */
    ...
    .hotspot--bubble-gum-bed {
        top: 19%;
        right: 58%;
    }
    
    .hotspot--bubble-gum-bed .hotspot--title {
        top: 0%;
        right: 105%;
    }
    
    .hotspot--bubble-gum-bed-mobile {
        top: 43%;
        left: 22%;
    }
    
    .hotspot--little-bunny-chair-2 {
        top: 75%;
        left: 70%;
    }
    
    .hotspot--little-bunny-chair-2 .hotspot--title {
        bottom: -15%;
        right: 105%;
    }
    
    .hotspot--little-bunny-chair-mobile-2 {
        top: 75%;
        left: 75%;
    }
    /* fimslide 2 */
    ...
    .hotspot--little-bunny-chair {
        bottom: 34%;
        left: 20%;
    }
    
    .hotspot--little-bunny-chair .hotspot--title {
        bottom: 18%;
        left: 105%;
    }
    
    .hotspot--little-bunny-chair-mobile {
        bottom: 36%;
        left: 43%;
    }
    
    .hotspot--bubble-gum-dressing-table {
        bottom: 36%;
        left: 43%;
    }
    
    .hotspot--bubble-gum-dressing-table .hotspot--title {
        bottom: 18%;
        left: 105%;
    }
    
    .hotspot--bubble-gum-dressing-table-mobile {
        bottom: 36%;
        left: 43%;
    }
    
    .hotspot--letter-b-graphic-collection {
        bottom: 29%;
        right: 8%;
    }
    
    .hotspot--letter-b-graphic-collection .hotspot--title {
        bottom: 18%;
        right: 105%;
    }
    /* fim slide 3 */
