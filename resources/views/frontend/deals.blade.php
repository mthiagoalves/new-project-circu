...
<div class="container-fluid pb-2" id="main-slide">
    <div class="row">
        ...
        <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=banner-categoria&utm_conteudo=circu-springsale23&utm_campanha=springsale">
          <img src="/img/slides/main/spring-sale-homepage.jpg" alt="Stocklist Spring Sale Circu Magical Furniture" class="d-none d-sm-block">
        </a>
            <div class="item">
        ...
        <a href="https://www.circu.net/ebook/stocklist-spring-sale?utm_origem=website&utm_meio=banner-categoria&utm_conteudo=circu-springsale23&utm_campanha=springsale">
          <img src="/img/slides/main/spring-sale-homepage-m.jpg" alt="Stocklist Spring Sale Circu Magical Furniture" class="d-block d-sm-none">
        </a>
            <div class="item">
            ...
            <div class="item col-12 p-0 position-relative">
                ...
                <div class="hotspot hotspot--title__left d-none d-lg-block" style="top: 61%;left: 48%;">
                    ...
                    <div class="hotspot--title text-center" style="bottom: 18%;left: 105%;">
                        ...
                        <a rel="modal:open" href="{{ route('modal-product-price', 'cloud-sofa') }}">
                            <div class="hotspot-get-price"><span>GET PRICE</span></div>
                        </a>
                    </div>
                </div>
                ...
                <div class="hotspot hotspot--title__left d-none d-lg-block" style="top: 24%;left: 9%;">
                    ...
                    <div class="hotspot--title text-center" style="top: 18%;left: 105%;">
                        ...
                        <a rel="modal:open" href="{{ route('modal-product-price', 'nodo-suspension-chair') }}">
                            <div class="hotspot-get-price"><span>GET PRICE</span></div>
                        </a>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable" href="{{ route('modal-product-price', $product2->slug) }}"><span>GET
                                <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
