				...
				<div class="product_thumb py-4 px-3">
					...
					<div class="col-12 clearfix position-relative mt-1 p-0">
						<div class="slideToggle">
							<a rel="modal:open" class="btn-green-underline mt-0 modal-cursor-disable" href="{{ route('modal-finish-info', $sample->slug) }}"><span>GET <b>INFO <i class="fas fa-caret-right"></i></b></span></a>
						</div>
					</div>
