...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/green-mint-playroom/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/green-mint-playroom/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 pt-4">
                <p class="text-uppercase text-center text-title-banner1 pb-0 pb-md-1 mb-0">Green Mint Playroom</p>
                <p class="text-uppercase text-center text-title-banner1 pb-2 pb-lg-2">The True Colors of Adventure and Fun at Home</p>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid p-0 pb-2 pt-1">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>The summer season is the ideal time to renew and refresh your child's room, and nothing better than painting it with the most irreverent colours like the blue of the sky and the green of nature. Circu's new playroom combines adventure and fun in the right doses, so that the magic and unique values of childhood are never lost.</span></p>
    </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    ...
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/green-mint-playroom/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/green-mint-playroom/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/green-mint-playroom/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/green-mint-playroom/banner-3-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
          <div class="product_thumb py-4 px-3">
              <img src="/img/products/thumbnails/magical-market-playroom-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
              
              <div class="product--title">
                  <span class="name">Magical Market</span>
                  <span class="sub_category">Playground</span>
              </div>

              <div class="col-12 clearfix position-relative mt-1 p-0">
                  <div class="slideToggle">
                      <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/magical-market-playroom"><span>GET
              ...
              <div class="product-box--content">
                      <div>
                          <a href="https://www.circu.net/products/magical-market-playroom">
                              <img src="/img/products/thumbnails-covers/magical-market-playroom-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                          </a>
                      </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/diana-floor-lamp"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div class="col-12 slider-for text-center">
                        <a href="https://www.circu.net/products/diana-floor-lamp">
                            <img src="/img/products/diana-floor-lamp/finishes/diana-floor-lamp-circu-magical-furniture-milk.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-floor-lamp">
                            <img src="/img/products/diana-floor-lamp/finishes/diana-floor-lamp-circu-magical-furniture-candy-red.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0">
                        <div class="d-inline text-center px-1">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
          <div class="product_thumb py-4 px-3">
             <img src="/img/products/thumbnails/minelli-bookcase-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
              ...
              <div class="col-12 clearfix position-relative mt-1 p-0">
                  <div class="slideToggle">
                      <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/minelli-bookcase"><span>GET
                              <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                  </div>
              </div>
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/green-mint-playroom/banner-4.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute moodboards-title" style="z-index:10;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/green-mint-playroom/banner-5.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0 text-uppercase"><span>GREEN MINT PLAYROOM</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/green-mint-playroom/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/green-mint-playroom/banner-6-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
...
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
          <div class="product_thumb py-4 px-3">
              <img src="/img/products/thumbnails/dolly-monkey-bars-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
              
              <div class="product--title">
                  <span class="name">Dolly</span>
                  <span class="sub_category">Monkey Bars</span>
              </div>

              <div class="col-12 clearfix position-relative mt-1 p-0">
                  <div class="slideToggle">
                      <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/dolly-monkey-bars"><span>GET
                              <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                  </div>
              </div>
                  <div class="new-product" style="top: 2%;right: 2%;width: 19%;">
              ...
              <div class="product-box--content">
                        <div>
                          <a href="https://www.circu.net/products/dolly-monkey-bars">
                              <img src="/img/products/thumbnails-covers/dolly-monkey-bars-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                          </a>
                      </div>
                  <div class="col-12 clearfix position-relative mt-3 p-0">
                      <div class="slideToggle">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
          <div class="product_thumb py-4 px-3">
              <img src="/img/products/thumbnails/letter-j-graphic-collection-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
              
              <div class="product--title">
                  <span class="name">Letter J</span>
                  <span class="sub_category">Graphic Lamps</span>
              </div>

              <div class="col-12 clearfix position-relative mt-1 p-0">
                  <div class="slideToggle">
                      <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/letter-j-graphic-collection"><span>GET
                              <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                  </div>
              </div>
              ...
              <div class="product-box--content">
                                                          <div>
                          <a href="https://www.circu.net/products/letter-j-graphic-collection">
                              <img src="/img/products/thumbnails-covers/letter-j-graphic-collection-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                          </a>
                      </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
          <div class="product_thumb py-4 px-3">
               <img src="/img/products/thumbnails/cuddle-armchair-and-ottoman-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
              
              <div class="product--title">
                  <span class="name">Cuddle</span>
                  <span class="sub_category">Armchair And Ottoman</span>
              </div>

              <div class="col-12 clearfix position-relative mt-1 p-0">
                  <div class="slideToggle">
                      <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/cuddle-armchair-and-ottoman"><span>GET
                              <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                  </div>
              </div>
              ...
              <div class="product-box--content">
                                                          <div>
                          <a href="https://www.circu.net/products/cuddle-armchair-and-ottoman">
                              <img src="/img/products/thumbnails-covers/cuddle-armchair-and-ottoman-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                          </a>
                      </div>
