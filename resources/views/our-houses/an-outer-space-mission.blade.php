...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/an-outer-space-mission/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/an-outer-space-mission/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:5%;">
                <p class="text-uppercase text-center text-title-banner1 pb-2 pb-lg-4">An Outer Space Mission with Cozy Studio</p>
...
<div class="container-fluid p-0 pb-2 pt-4">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>Circu continues its mission to bring pieces from out of this world continues and this one is no different. Spoiler alert: We had a major help for this one.<br>
                When we talk about the mission we mean NASA style. Circu partner up with Cozy Studio, and its designer, Renata Aquino, to bring you a kids room that is out of this world. All you need to do is follow us around and see this amazing project that shines brighter than the moon.</span></p>
    </div>
    @php $room = 'An Outer Space Mission'; @endphp
    <div class="col-12 text-center pt-3 d-none d-md-block">
        <div class="row justify-content-center">
            <a class="btn-green-underline mt-0 m-0 mr-2 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-outer-space-mission')}}"><span><b>GET PROJECT PRICE</b></span></a>
    ...
    <div class="col-12 text-center pt-3 d-block d-md-none">
        <div class="col-12 p-0">
            <a class="btn-green-underline m-0 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-outer-space-mission')}}"><span><b>GET PROJECT PRICE</b></span></a>
        </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    <div class="col-12 ">
        <h2 class="col-12 name_title text-center mb-0"><span>SPACE BEDROOM</span></h2>
    </div>
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-3-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
...
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/atomic-suspension-lamp-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/atomic-suspension-lamp"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div class="col-12 slider-for text-center ">
                        <a href="https://www.circu.net/products/atomic-suspension-lamp">
                            <img src="/img/products/atomic-suspension-lamp/finishes/atomic-suspension-lamp-circu-magical-furniture-gold-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/atomic-suspension-lamp">
                            <img src="/img/products/atomic-suspension-lamp/finishes/atomic-suspension-lamp-circu-magical-furniture-nickel-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/atomic-suspension-lamp">
                            <img src="/img/products/atomic-suspension-lamp/finishes/atomic-suspension-lamp-circu-magical-furniture-copper-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/gold-plated-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/nickel-plated-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/copper-plated-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="http://circu.net/includes/modal-product-price/cloud-bed"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/diana-table-lamp-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/diana-table-lamp"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div class="col-12 slider-for text-center">
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-light-blue.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-light-pink.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-gold-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-nickel-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-royal-blue.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-candy-red.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/diana-table-lamp">
                            <img src="/img/products/diana-table-lamp/finishes/diana-table-lamp-circu-magical-furniture-lemon-yellow.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
                        <div class="d-inline text-center px-1">
                        ...
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/royal-blue-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/candy-red-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/lemon-yellow-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-12 clearfix position-relative mt-3 p-0">
                        <div class="slideToggle">
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-4.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3%;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-5.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0"><span>MISSION PLAYROOM</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-6-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pt-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-7.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pt-2">
            <img src="/img/our-houses/new/an-outer-space-mission/banner-8.jpg" class="img-fluid w-100">
        </div>
    </div>
</div>
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/rocky-rocket-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Rocky Rocket</span>
                    <span class="sub_category">Sofa / Chair</span>
                </div>
                    ...
                    <div class="col-12 slider-for text-center ">
                        <div>
                            <a href="https://www.circu.net/products/rocky-rocket">
                                <img src="/img/products/rocky-rocket/finishes/rocky-rocket-circu-magical-furniture-white-red.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/rocky-rocket">
                                <img src="/img/products/rocky-rocket/finishes/rocky-rocket-circu-magical-furniture-white-pink.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/rocky-rocket">
                                <img src="/img/products/rocky-rocket/finishes/rocky-rocket-circu-magical-furniture-white-creme.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
                        <div class="d-inline text-center">
                            <img src="/img/icons/finishes/white-red-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/white-pink-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                        <div class="d-inline text-center">
                            <img src="/img/icons/finishes/white-creme-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/puzzled-bookcase-desk-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Puzzled</span>
                    <span class="sub_category">Bookcase | Desk</span>
                </div>
                    ...
                    <div class="col-12 slider-for text-center ">
                        <div>
                            <a href="https://www.circu.net/products/puzzled-bookcase-desk">
                                <img src="/img/products/puzzled-bookcase-desk/finishes/puzzled-bookcase-desk-circu-magical-furniture-milk.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/puzzled-bookcase-desk">
                                <img src="/img/products/puzzled-bookcase-desk/finishes/puzzled-bookcase-desk-circu-magical-furniture-light-pink.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/puzzled-bookcase-desk">
                                <img src="/img/products/puzzled-bookcase-desk/finishes/puzzled-bookcase-desk-circu-magical-furniture-light-blue.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/astroman-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Astroman</span>
                    <span class="sub_category">Rug</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/astroman-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/astroman-rug">
                            <img src="/img/products/thumbnails-covers/astroman-rug-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 clearfix position-relative mt-3 p-0">
                        <div class="slideToggle">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/moon-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/moon-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/moon-rug">
                            <img src="/img/products/thumbnails-covers/moon-rug-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 clearfix position-relative mt-3 p-0">
                        <div class="slideToggle">
