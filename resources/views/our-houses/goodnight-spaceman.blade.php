...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/spaceman-room/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/spaceman-room/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:7%;">
                <a href="/virtual-tour/goodnight-spaceman-room/">
...
<div class="container-fluid p-0 pb-2 pt-4">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>Circu continues its mission to bring pieces from out of this world to brighten up 2021 and all of your design projects. And when we talk about the mission we mean NASA style. We moved heavens and earth to bring you this room full of spots to explore and new adventures to come. All you need to do is press Start and come along with us. <br><br>When we enter the room we are immediately drawn to the sleeping area. With a color palette that ranges between light grey and pastel shades, the cloud bed is the chosen piece that does deliver the sensation of levity and being lost in space and imagination. The stellar rug matches perfectly with the theme of the bedroom as well as the Cloud Bed. It is the ideal piece for the little space adventures who love to look up to the sky every night and count the stars.
                Every bedroom, especially for kids, needs all the storage you can get. The modern closet is complemented by the sky nightstands that give the room a vintage look while still remarking traveling - in this case, to a different dimension. Above the nightstands, we find our atomic wall lamps that provide the exact amount of light - and coolness - the bedroom needs.<br><br>This bedroom will not be completed without an out-of-this-world playground with Rocky Rocket as the centerpiece. This armchair breaths space and it's the dream of every little astronaut. The incorporated RGB light also comes with speakers, that can be controlled by a mobile app- or with remote control- and you can create your own "Take off to Space" playlist.<br><br>A playground is nothing without a study area. How else would your little astronaut learn more about the stars?</span></p>
    </div>
    @php $room = 'Goodnight Spaceman'; @endphp
    <div class="col-12 text-center pt-3 d-none d-md-block">
        <div class="row justify-content-center">
            <a class="btn-green-underline mt-0 m-0 mr-2" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price')}}"><span><b>GET PROJECT PRICE</b></span></a>
    ...
    <div class="col-12 text-center pt-3 d-block d-md-none">
        <div class="col-12 p-0">
            <a class="btn-green-underline m-0" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price')}}"><span><b>GET PROJECT PRICE</b></span></a>
        </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    ...
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/spaceman-room/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/spaceman-room/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/spaceman-room/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/spaceman-room/banner-3.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
...
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/sky-nightstand">
                            <img src="/img/products/thumbnails-covers/sky-nightstand-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/stellar-round-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Stellar Round</span>
                    <span class="sub_category">Rug</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/stellar-round-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/stellar-round-rug">
                            <img src="/img/products/thumbnails-covers/stellar-round-rug-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/atomic-wall-lamp-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/atomic-wall-lamp"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                    ...
                    <div class="col-12 slider-for text-center ">
                        <div>
                            <a href="https://www.circu.net/products/atomic-wall-lamp">
                                <img src="/img/products/atomic-wall-lamp/finishes/atomic-wall-lamp-circu-magical-furniture-gold-plated.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/atomic-wall-lamp">
                                <img src="/img/products/atomic-wall-lamp/finishes/atomic-wall-lamp-circu-magical-furniture-nickel-plated.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/atomic-wall-lamp">
                                <img src="/img/products/atomic-wall-lamp/finishes/atomic-wall-lamp-circu-magical-furniture-copper-plated.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/spaceman-room/banner-5.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3%;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/spaceman-room/banner-4.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0"><span>SPACE PLAYROOM</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/spaceman-room/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/spaceman-room/banner-6.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/stellar-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/stellar-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/stellar-rug">
                            <img src="/img/products/thumbnails-covers/stellar-rug-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/our-houses/new/spaceman-room/marie-chair.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a class="btn-green-underline mt-0" href="https://www.covethouse.eu/products/marie-dining-chair/" target="_blank"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                <div class="product-box--content">
                    <div>
                        <a href="https://www.covethouse.eu/products/marie-dining-chair/" target="_blank">
                            <img src="/img/our-houses/new/spaceman-room/marie-chair.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 clearfix position-relative mt-3 p-0">
                        <div class="slideToggle">
