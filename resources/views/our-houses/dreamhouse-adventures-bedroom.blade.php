...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 pt-4">
                <p class="text-uppercase text-center text-title-banner1 pb-0 pb-md-1 mb-0">Dreamhouse Adventures Bedroom</p>
                <p class="text-uppercase text-center text-title-banner1 pb-2 pb-lg-2">One room, endless stories to be lived</p>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid p-0 pb-2 pt-1">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>Every child's dream is to live in an enchanted realm or experience the fantastic adventures of their favourite cartoons. This exceptional room is all about that, allowing the toddler to be the leading character in its adventures in a secure and fun environment. The Dolly playhouse is the set. The child is the main character. The ambience is the full script waiting to be written. A room with a contemporary aesthetic and a soothing aura without many elements to give the spotlight to the lively bed. Subtle lighting elements provide the exact amount of light exposure for maximum concentration when the time is not for play. A sober bedroom aesthetic that besides telling its own story, secures the space and represent the set for a new one, each day.</span></p>
    </div>
    @php $room = 'Dreamhouse Adventure Bedroom'; @endphp
    <div class="col-12 text-center pt-3 d-none d-md-block">
        <div class="row justify-content-center">
            <a class="btn-green-underline mt-0 m-0 mr-2 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-dreamhouse')}}"><span><b>GET PROJECT PRICE</b></span></a>
    ...
    <div class="col-12 text-center pt-3 d-block d-md-none">
        <div class="col-12 p-0">
            <a class="btn-green-underline m-0 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-dreamhouse')}}"><span><b>GET PROJECT PRICE</b></span></a>
        </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    ...
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-3-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/dolly-playhouse-bed-circu-magical-furniture.png" class="img-fluid" width="960" height="800">
                <div class="product--title">
                    <span class="name">Dolly Playhouse</span>
                    <span class="sub_category">Bed</span>
                </div>
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/dolly-playhouse-bed"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/dolly-playhouse-bed">
                            <img src="/img/products/thumbnails-covers/dolly-playhouse-bed-circu-magical-furniture.jpg" alt="" class="img-fluid" width="500" height="420">
                        </a>
                    </div>
            ...
            <div class="product_thumb py-4 px-3 banner-height-2">
                ...
                <div class="product-box--content align-items-end banner-height-2">
                    <a href="https://www.circu.net/products/animal-stool-elephant">
                        <img src="/img/products/thumbnails-covers/animal-stool-elephant-circu-magical-furniture.jpg" width="500" height="360" alt="" class="img-fluid" style="width:100%;">
                    </a>

                    <div class="product-box--share col-12 clearfix">
                        <div class="slideToggle">
                            <a rel="modal:open" class="btn-green-underline" href="https://www.circu.net/includes/modal-product-price/animal-stool-elephant"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/the-power-elephant-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                    <span class="name">The Power Elephant</span>
                    <span class="sub_category">Rug</span>
                </div>
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/the-power-elephant-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                <div class="product-box--content align-items-end banner-height-2">
                    <a href="https://www.circu.net/products/the-power-elephant-rug">
                        <img src="/img/products/thumbnails-covers/the-power-elephant-rug-circu-magical-furniture.jpg" width="500" height="360" alt="" class="img-fluid" style="width:100%;">
                    </a>

                    <div class="product-box--share col-12 clearfix">
                        <div class="slideToggle">
                            <a rel="modal:open" class="btn-green-underline" href="https://www.circu.net/includes/modal-product-price/the-power-elephant-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-4.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute moodboards-title" style="z-index:10;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-5.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0 text-uppercase"><span>Dreamhouse Adventures Bedroom</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/dreamhouse-adventures-bedroom/banner-6-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
...
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/mr-ice-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                    <span class="name">MR. Ice</span>
                    <span class="sub_category">Rug</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/mr-ice-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                <div class="product-box--content align-items-end banner-height-2">
                    <a href="https://www.circu.net/products/mr-ice-rug">
                        <img src="/img/products/thumbnails-covers/mr-ice-rug-circu-magical-furniture.jpg" width="500" height="360" alt="" class="img-fluid" style="width:100%;">
                    </a>

                    <div class="product-box--share col-12 clearfix">
                        <div class="slideToggle">
                            <a rel="modal:open" class="btn-green-underline" href="https://www.circu.net/includes/modal-product-price/mr-ice-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                        </div>
                    </div>
                </div>
            </div>
