...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/blossom-fairytale/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/blossom-fairytale/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:5%;">
                <p class="text-uppercase text-center text-title-banner1 pb-2 pb-lg-4">Blossom Fairytale by We Wnętrzu</p>
...
<div class="container-fluid p-0 pb-2 pt-4">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>Imagination is a powerful tool, especially when it comes to designing kids' bedrooms. Aiming for new limits CIRCU partner up with Poland's top designers<br> <b>We Wnętrzu</b>, for the creation of a magical place where new fairytales will blossom and new dreams will take place.</span></p>
    </div>
    @php $room = 'Blossom Fairytale'; @endphp
    <div class="col-12 text-center pt-3 d-none d-md-block">
        <div class="row justify-content-center">
            <a class="btn-green-underline mt-0 m-0 mr-2 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-blossom')}}"><span><b>GET PROJECT PRICE</b></span></a>
    ...
    <div class="col-12 text-center pt-3 d-block d-md-none">
        <div class="col-12 p-0">
            <a class="btn-green-underline m-0 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-blossom')}}"><span><b>GET PROJECT PRICE</b></span></a>
        </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    <div class="col-12 ">
        <h2 class="col-12 name_title text-center mb-0"><span>FAIRTALE BEDROOM</span></h2>
    </div>
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/blossom-fairytale/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/blossom-fairytale/banner-3-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/bubble-gum-bed-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/bubble-gum-bed"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/bubble-gum-bed">
                            <img src="/img/products/thumbnails-covers/bubble-gum-bed-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/cloud-nightstand-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/cloud-nightstand"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                    ...
                    <div class="col-12 slider-for text-center ">
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-sage-grey.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-light-blue.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-light-pink.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-cream.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-taupe.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cloud-nightstand">
                                <img src="/img/products/cloud-nightstand/finishes/cloud-nightstand-circu-magical-furniture-milk.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/cloud-rug-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/cloud-rug"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/cloud-rug">
                            <img src="/img/products/thumbnails-covers/cloud-rug-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-4.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3%;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-5.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0"><span>JUNGLE PLAYROOM</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/blossom-fairytale/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/blossom-fairytale/banner-6-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pt-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-7.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3%;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pt-2">
            <img src="/img/our-houses/new/blossom-fairytale/banner-8.jpg" class="img-fluid w-100">
        </div>
    </div>
</div>
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/cotton-candy-sofa-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Cotton Candy</span>
                    <span class="sub_category">Sofa</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/cotton-candy-sofa"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                    ...
                    <div class="col-12 slider-for text-center ">
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-light-pink-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-light-blue-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-taupe-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-cream-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-sage-grey-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-milk-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div>
                            <a href="https://www.circu.net/products/cotton-candy-sofa">
                                <img src="/img/products/cotton-candy-sofa/finishes/cotton-candy-sofa-circu-magical-furniture-lilac-velvet.png" width="960" height="800" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0 ">
                        ...
                        <div class="d-inline text-center px-1">
                            <img src="/img/icons/finishes/lilac-velvet-sm.png" width="20" height="20" alt="" class="img-fluid">
                        </div>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/hoppman-side-table-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Hoppman</span>
                    <span class="sub_category">Side Table</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/hoppman-side-table"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/hoppman-side-table">
                            <img src="/img/products/thumbnails-covers/hoppman-side-table-circu-magical-furniture.jpg" width="500" height="420" alt="" class="img-fluid">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                ...
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/animal-stool-elephant"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
