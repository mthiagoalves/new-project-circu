...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0">
            <img src="/img/our-houses/single-page/boy-room/banners/banner-d.jpg" class="img-fluid img-height d-none d-md-block" style="width: 100%;">
            <img src="/img/our-houses/single-page/boy-room/banners/banner-m.jpg" class="img-fluid img-height-mobile d-block d-md-none" style="width: 100%;">
            <a href="https://www.circu.net/virtual-tour/our-houses-boy-room-2021/" target="_blank" style="z-index:2;">
...
<div class="container-fluid p-0 pt-2 section-form">
    <div class="col-12 ">
        <h2 class="col-12 category_name_title text-center mb-0"><span>LITTLE-BOY BEDROOM</span></h2>
    </div>
</div>
...
<div class="container-fluid p-0 ">
    <div class="row m-0 p-0 my-gallery" id="gallery">
        ...
        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-1-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-1-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-2-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-2-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-3-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-3-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-4-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-4-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-6 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-1-horizontal.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-1-horizontal.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-5-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-5-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>

        <figure class="col-12 col-md-3 p-0 m-0" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
            <a href="/img/our-houses/single-page/boy-room/images/boy-room-6-vertical.jpg" itemprop="contentUrl" data-width="1679" data-height="1108">
                <img src="/img/our-houses/single-page/boy-room/images/boy-room-6-vertical.jpg" itemprop="thumbnail" alt="Boy Room" style="width: 100%;height: 100%;padding-bottom: 2px;padding-right: 2px;" />
            </a>
        </figure>
    </div>
</div>
...
<div class="container-fluid p-0 pt-2">
    <div class="col-12 text-center slideToggle p-0 py-3">
        <a rel="modal:open" href="{{ route('modal-download-hr-images-boy') }}" class="btn-green-underline "><span style="color:white;"><b>GET HR IMAGES</b></span></a>
    </div>
</div>
    ...
    <div class="row m-0 p-0">
        <div class="col-12 p-0 d-none d-md-block">
            <video width="100%" height="auto" onloadeddata="this.play();" autoplay="" muted="" loop="" playsinline="">
                <source src="/img/our-houses/single-page/boy-room/boy-room-d.mp4" type="video/mp4">
            </video>
        </div>
        <div class="col-12 p-0 d-block d-md-none">
            <video width="100%" height="auto" onloadeddata="this.play();" autoplay="" muted="" loop="" playsinline="">
                <source src="/img/our-houses/single-page/boy-room/boy-room-m.mp4" type="video/mp4">
            </video>
        </div>
    </div>
</div>
...
<div class="container-fluid p-0">
    <div class="col-12 owl-products owl-carousel owl-slide owl-theme p-0 position-relative">
        ...
        @if($product->slug == "illusion-stool-white-bear" || $product->slug == "fantasy-air-shelf-big" || $product->slug == "fantasy-air-shelf-small" || $product->slug == "cloud-bed" || $product->slug == "cloud-nightstand" || $product->slug == "little-cloud-nightstand" || $product->slug == "cloud-lamp-small" || $product->slug == "cloud-shelf-small" || $product->slug == "cloud-shelf-big" || $product->slug == "cloud-mirror" || $product->slug == "animal-stool-shark" || $product->slug == "cloud-bench-2-seat" || $product->slug == "cloud-chest-6-drawers" || $product->slug == "diana-table-lamp" || $product->slug == "magical-mirror-blue" || $product->slug == "fantasy-air-chest-3-drawers" || $product->slug == "dream-desk")
        ...
        <div class="col-12 p-0">
            <div class="col-12 col-md-3 p-0 float-left " style="cursor:pointer;">
                <a href="https://www.circu.net/our-magical-girl-room">
                    <img src="/img/our-houses/single-page/banners/girl-bedroom.jpg" class="img-fluid" style="width: 100%;">
