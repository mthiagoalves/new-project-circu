...
<div class="container-fluid p-0">
    <div class="row m-0 p-0">
        <div class="col-12 p-0 ">
            <img src="/img/our-houses/new/a-room-above-the-clouds/main-banner-d.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/new/a-room-above-the-clouds/main-banner-m.jpg" class="img-fluid d-block d-md-none" style="width: 100% !important;">
            <div class="col-12 p-0 pt-4">
                <p class="text-uppercase text-center text-title-banner1 pb-0 pb-md-1 mb-0">A Room Above The Clouds</p>
                <p class="text-uppercase text-center text-title-banner1 pb-2 pb-lg-2">Where childhood dreams come true</p>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid p-0 pb-2 pt-1">
    <div class="row justify-content-center m-0">
        <p class="col-12 col-md-9 texto_room text-center mb-0"><span>What if all the tales of magical lamps and light bulbs, fairies and pixie dust, children hear and believe growing up did actually come true? What if enchated realms existed and it only took one whimsical lamp and a few simple wishes to get there? That's what we're about to discover within the details of this special project designed by Pascale Hakimeh. With Circu's magical pieces, Hakimeh created the most captivating little kids' room of all, one worthy of being narrated about in all fairytales yet to come.
                The adventure started when once upon a time, two twins received a very special gift in the shape of a unique lamp, and discovered that a small pink fairy with the ability to fulfill any and every wish they could have ever dream of, lived in between the lights of the lamp.</span></p>
    </div>
    @php $room = 'A Room Above The Clouds'; @endphp
    <div class="col-12 text-center pt-3 d-none d-md-block">
        <div class="row justify-content-center">
            <a class="btn-green-underline mt-0 m-0 mr-2 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-room-above-the-clouds')}}"><span><b>GET PROJECT PRICE</b></span></a>
    ...
    <div class="col-12 text-center pt-3 d-block d-md-none">
        <div class="col-12 p-0">
            <a class="btn-green-underline m-0 modal-cursor-disable" style="padding: 5px 37px 4px !important;" rel="modal:open" href="{{route('modal-get-project-price-room-above-the-clouds')}}"><span><b>GET PROJECT PRICE</b></span></a>
        </div>
...
<div class="container-fluid p-0 pb-2 pt-4 ">
    ...
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-1.jpg" class="img-fluid w-100">
        ...
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-2.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-3.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-3-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
    </div>
</div>
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/fantasy-air-balloon-circu-magical-furniture.png" class="img-fluid" width="960" height="800">
                <div class="product--title">
                    <span class="name">Fantasy Air Balloon</span>
                    <span class="sub_category">Crib / Bed / Sofa</span>
                </div>
                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/fantasy-air-balloon"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                <div class="product-box--content">
                    <div>
                        <a href="https://www.circu.net/products/fantasy-air-balloon">
                            <img src="/img/products/thumbnails-covers/fantasy-air-balloon-circu-magical-furniture.jpg" alt="" class="img-fluid" width="500" height="420">
                        </a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/fantasy-air-nightstand-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                    <span class="name">Fantasy Air</span>
                    <span class="sub_category">Nightstand</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/fantasy-air-nightstand"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>

                <div class="product-box--content">
                    <div class="col-12 slider-for text-center">
                        <a href="https://www.circu.net/products/fantasy-air-nightstand/test">
                            <img src="/img/products/fantasy-air-nightstand/finishes/fantasy-air-nightstand-circu-magical-furniture-gold-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/fantasy-air-nightstand/test">
                            <img src="/img/products/fantasy-air-nightstand/finishes/fantasy-air-nightstand-circu-magical-furniture-nickel-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0">
                        <div class="d-inline text-center px-1">
...
<div class="container-fluid p-0 pb-2">
    <div class="row pt-2 m-0">
        <div class="col-12 col-md-6 p-0 pr-0 pr-md-1 pb-2">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-4.jpg" class="img-fluid w-100">
            <div class="col-12 p-0 position-absolute moodboards-title" style="z-index:10;">
                <h2 class="col-12 name_title text-center mb-0"><span>INSPIRATION MOODBOARD</span></h2>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pl-0 pl-md-1 pb-2">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-5.jpg" class="img-fluid w-100">
        </div>
        <div class="col-12 ">
            <h2 class="col-12 name_title text-center mb-0 text-uppercase"><span>A Room Above The Clouds</span></h2>
        </div>
        <div class="col-12 p-0">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-6.jpg" class="img-fluid w-100 d-none d-md-block">
            <img src="/img/our-houses/new/a-room-above-the-clouds/banner-6-m.jpg" class="img-fluid w-100 d-block d-md-none">
        </div>
...
<div class="container-fluid pb-2">
    ...
    <div class="row pt-2 ">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3">
                <img src="/img/products/thumbnails/fantasy-air-bookcase-circu-magical-furniture.png" width="960" height="800" class="img-fluid">

                <div class="product--title">
                    <span class="name">Fantasy Air Bookcase</span>
                    <span class="sub_category">Bookcase</span>
                </div>

                <div class="col-12 clearfix position-relative mt-1 p-0">
                    <div class="slideToggle">
                        <a rel="modal:open" class="btn-green-underline mt-0" href="https://www.circu.net/includes/modal-product-price/fantasy-air-bookcase"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                    </div>
                </div>
                ...
                <div class="product-box--content">
                    <div class="col-12 slider-for text-center">
                        <a href="https://www.circu.net/products/fantasy-air-bookcase/test">
                            <img src="/img/products/fantasy-air-bookcase/finishes/fantasy-air-bookcase-circu-magical-furniture-gold-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                        <a href="https://www.circu.net/products/fantasy-air-bookcase/test">
                            <img src="/img/products/fantasy-air-bookcase/finishes/fantasy-air-bookcase-circu-magical-furniture-nickel-plated.png" width="960" height="800" alt="" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-12 product-samples slider-nav text-center p-0">
                        <div class="d-inline text-center px-1">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/gold-box-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                    <span class="name">Gold</span>
                    <span class="sub_category">Toy Box</span>
                </div>
                ...
                <div class="product-box--content align-items-end banner-height-2">
                    <a href="https://www.circu.net/products/gold-box">
                        <img src="/img/products/thumbnails-covers/gold-box-circu-magical-furniture.jpg" width="500" height="360" alt="" class="img-fluid" style="width:100%;">
                    </a>

                    <div class="product-box--share col-12 clearfix">
                        <div class="slideToggle">
                            <a rel="modal:open" class="btn-green-underline" href="https://www.circu.net/includes/modal-product-price/gold-box"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 product-box">
            <div class="product_thumb py-4 px-3 banner-height-2">
                <img src="/img/products/thumbnails/magical-mirror-circu-magical-furniture.png" width="960" height="800" class="img-fluid">
                <div class="product--title">
                    <span class="name">Magical Mirror</span>
                    <span class="sub_category">Mirror With Tv 22"</span>
                </div>
                ...
                <div class="product-box--content align-items-end banner-height-2">
                    <a href="https://www.circu.net/products/magical-mirror">
                        <img src="/img/products/thumbnails-covers/magical-mirror-circu-magical-furniture.jpg" width="500" height="360" alt="" class="img-fluid" style="width:100%;">
                    </a>

                    <div class="product-box--share col-12 clearfix">
                        <div class="slideToggle">
                            <a rel="modal:open" class="btn-green-underline" href="https://www.circu.net/includes/modal-product-price/magical-mirror"><span>GET <b>PRICE <i class="fas fa-caret-right"></i></b></span></a>
                        </div>
                    </div>
                </div>
            </div>
