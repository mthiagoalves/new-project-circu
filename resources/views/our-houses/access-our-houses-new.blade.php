...
<div class="container-fluid pb-2" id="main-slide">
    <div class="row">
        ...
        <div class="col-12 owl-main owl-carousel owl-slide owl-theme p-0 position-relative ">
            ...
            <div class="item">
                <img src="/img/our-houses/new/little-rising-star-bedroom-d.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/little-rising-star-bedroom-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
            <div class="item">
                <img src="/img/our-houses/new/an-outer-space-mission-room.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/an-outer-space-mission-room-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
            <div class="item">
                <img src="/img/our-houses/new/covet-house-opulent-modern-classic-villa-in-riyadh-rooms.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/covet-house-opulent-modern-classic-villa-in-riyadh-rooms-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
            <div class="item">
                <img src="/img/our-houses/new/banner-blossom-fairytale.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/banner-blossom-fairytale-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
            <div class="item">
                <img src="/img/our-houses/new/banner-jungle-fun.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/banner-jungle-fun-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
            <div class="item">
                <img src="/img/our-houses/new/banner-d.jpg" width="1920" height="800" alt="Circu Magical World" class="cd-dot img-fluid d-none d-sm-block" style="width:100% !important;">
                <img src="/img/our-houses/new/banner-m.jpg" width="552" height="432" alt="Circu Magical World" class="cd-dot img-fluid d-block d-sm-none">
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid p-0 ">
    <div class="row m-0 p-0">
        <div class="col-12 col-md-4 p-0" style="cursor:pointer; outline: 3px solid white; outline-offset: 0px;">
            ...
            <img src="/img/our-houses/new/banners-rooms/green-mint-playroom.jpg" class="img-fluid" style="width: 100%;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3.7%;">
                <h2 class="col-12 category_name_room_title text-center mb-0 pb-1" style="color:white !important; "><span>Green Mint Playroom</span></h2>
        ...
        <div class="col-12 col-md-4 p-0" style="cursor:pointer; outline: 3px solid white; outline-offset: 0px;">
            ...
            <img src="/img/our-houses/new/banners-rooms/a-room-above-the-clouds.jpg" class="img-fluid" style="width: 100%;">
            <div class="col-12 p-0 position-absolute" style="z-index:10;bottom:3.7%;">
...
<div class="container-fluid p-0">
    <div class="col-12 owl-ambiences owl-carousel owl-slide owl-theme p-0">
        ...
        <div class="item col-12 p-0 position-relative">
            <img src="/img/our-houses/slide/ambient-1.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/slide/ambient-1-m.jpg" class="img-fluid d-block d-md-none">

            <div class="hotspot hotspot--cosmo hotspot--title__left d-none d-lg-block">
                <!-- desktop -->
                <div class="hotspot--cta"></div>
                <div class="hotspot--title text-center">
                    <div class="close-hotspot">X</div>
                    <a href="https://www.circu.net/products/cosmo-suspension-lamp">
                        <img src="/img/products/carousel/cosmo-suspension-lamp-circu-magical-furniture.jpg" width="364" height="380" class="img-fluid hotspot-img">
                        <div class="hotspot-name"><b>COSMO</b> SUSPENSION LAMP</div>
                        <div class="hotspot-description my-2 d-none d-lg-block">Designed as a tribute to the mid-20th century race to space, Cosmo modern chandelier is inspired by space, galaxies and the planets that surround us.</div>
                    </a>
                    <a rel="modal:open" href="{{route('modal-product-price', ['name' => 'cosmo-suspension-lamp'] )}}">
                        <div class="hotspot-get-price"><span>GET PRICE</span></div>
                    </a>
                </div>
            </div>

            <a class="hotspot hotspot--cosmo-mobile d-block d-lg-none" href="https://www.circu.net/products/cosmo-suspension-lamp">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>


            <div class="hotspot hotspot--cloud-sofa hotspot--title__left d-none d-lg-block">
                <!-- desktop -->
                <div class="hotspot--cta"></div>
                <div class="hotspot--title text-center">
                    <div class="close-hotspot">X</div>
                    <a href="https://www.circu.net/products/cloud-sofa">
                        ...
                        <div class="hotspot-description my-2 d-none d-lg-block">Inspired by Pixar’s short-film, this sofa has a cloud-shaped form, and it's the perfect item for any bedroom and any other division.</div>
                    </a>
            ...
            <a class="hotspot hotspot--cloud-sofa-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-sofa">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <div class="hotspot hotspot--nodo hotspot--title__left d-none d-lg-block">
                <!-- desktop -->
                <div class="hotspot--cta"></div>
                <div class="hotspot--title text-center">
                    <div class="close-hotspot">X</div>
                    <a href="https://www.circu.net/products/nodo-suspension-chair">
                        ...
                        <div class="hotspot-description my-2 d-none d-lg-block">NODO Suspension Chair will give you the comfort you never thought you needed.</div>
                    </a>
            ...
            <a class="hotspot hotspot--nodo-mobile d-block d-lg-none" href="https://www.circu.net/products/nodo-suspension-chair">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <div class="hotspot hotspot--dream-desk hotspot--title__left d-none d-lg-block">
                ...
                <div class="hotspot--title text-center">
                    ...
                    <a href="https://www.circu.net/products/dream-desk">
                        ...
                        <div class="hotspot-name"><b>DREAM</b> DESK</div>
                        <div class="hotspot-description my-2 d-none d-lg-block">The beautiful round shapes of the Cloud Collection made possible for us to create this Dream Desk.</div>
                    </a>
                    <a rel="modal:open" href="{{route('modal-product-price', ['name' => 'dream-desk'] )}}">
                        <div class="hotspot-get-price"><span>GET PRICE</span></div>
                    </a>
                </div>
            </div>
        ...
        <div class="item col-12 p-0 position-relative">
            <img src="/img/our-houses/slide/ambient-2.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/slide/ambient-2-m.jpg" class="img-fluid d-block d-md-none">

            <div class="hotspot hotspot--rocket hotspot--title__left d-none d-lg-block">
                <!-- desktop -->
                <div class="hotspot--cta"></div>
                <div class="hotspot--title text-center">
                    <div class="close-hotspot">X</div>
            ...
            <a class="hotspot hotspot--rocket-mobile d-block d-lg-none" href="https://www.circu.net/products/rocky-rocket">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>

            <div class="hotspot hotspot--puzzle hotspot--title__left d-none d-lg-block">
                <!-- desktop -->
                <div class="hotspot--cta"></div>
                <div class="hotspot--title text-center">
                    <div class="close-hotspot">X</div>
                    <a href="https://www.circu.net/products/puzzled-bookcase-desk">
                        ...
                        <div class="hotspot-description my-2 d-none d-lg-block">Inspired by geometric spaces and with the drive and passion to create a piece where kids can explore their imagination.</div>
                    </a>
        ...
        <div class="item col-12 p-0 position-relative">
            <img src="/img/our-houses/slide/ambient-3.jpg" class="img-fluid d-none d-md-block" style="width: 100% !important;">
            <img src="/img/our-houses/slide/ambient-3-m.jpg" class="img-fluid d-block d-md-none">
            ...
            <a class="hotspot hotspot--cloud-bed-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-bed">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <a class="hotspot hotspot--cloud-3-drawers-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-shelf-big">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <a class="hotspot hotspot--animal-stool-shark-mobile d-block d-lg-none" href="https://www.circu.net/products/animal-stool-shark">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>

            <a class="hotspot hotspot--cloud-lamp-big-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-lamp-big">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <a class="hotspot hotspot--little-cloud-nightstand-mobile d-block d-lg-none" href="https://www.circu.net/products/little-cloud-nightstand">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <a class="hotspot hotspot--cloud-nightstand-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-nightstand">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>

            <a class="hotspot hotspot--cloud-2seat-puff-mobile d-block d-lg-none" href="https://www.circu.net/products/cloud-bench-2-seat">
                <!-- mobile -->
                <span class="hotspot--cta"></span>
            </a>
            ...
            <div class="col-12 col-xl-11 offset-0 offset-xl-1 py-1">
                <div class="row">
                    <div class="col-12 col-lg-6 p-lg-0">
                        @include('includes.middle.form-catalogue-2021')
                    </div>
