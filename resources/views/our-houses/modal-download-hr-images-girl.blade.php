...
<body>
    ...
    <form method="post" class="form-popup form-parsley" action="{{ route('process.hr-images-girl-our-houses') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="input-block {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <select name="country" class="custom-select country country-hr" data-parsley-required="true" value="{{ old('country') }}" placeholder="Country*">
            ...
            <div class="col-sm-12 ">
                <div class="input-block {{ $errors->has('hear_about') ? 'has-error' : '' }} d-none state-hr">
    ...
    <script type="text/javascript">
        ...
        $(".country-hr").change(function() {
            var selected_option = $(this).val();
            if (selected_option === 'United States') {
                $('.state-hr').removeClass('d-none').children().attr('data-parsley-required', 'true');
            }
            if (selected_option != 'United States') {
                $('.state-hr').addClass('d-none').children().attr('data-parsley-required', 'false');
            }
        });
    </script>
