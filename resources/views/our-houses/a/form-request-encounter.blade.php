<form method="post" class="form-popup form-parsley form-access-vt" action="{{ route('process.book-appointment') }}">

    <div class="row m-0 p-0">

        {{ csrf_field() }}

        <input type="hidden" name="more_info" value="Book An Appointment" />
        ...
        <div class="col-12 col-md-6 p-0 pb-3 pb-md-0 pr-md-3 formvisible" style="display: none;">
            <div class="input-block m-0 mb-md-3 {{ $errors->has('showroom_day') ? 'has-error' : '' }}">
                <input type="date" name="showroom_day" class="form-control name" data-parsley-required="true" data-parsley-trigger="change" value="{{ old('showroom_day') }}"/>
            </div>
        </div>
        <div class="col-12 col-md-6 p-0 pb-3 pb-md-0 pl-md-0 formvisible" style="display: none;">
            <div class="input-block m-0 mb-md-3 {{ $errors->has('showroom_time') ? 'has-error' : '' }}">
                <input type="time" name="showroom_time" class="form-control name" data-parsley-required="true" data-parsley-trigger="change" value="{{ old('showroom_time') }}"/>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 p-0 pr-md-3 div-form-privacu-policy">
            <div class="col-12 p-0">
                <p class="text-uppercase">By clicking request, you confirm that you have read and accepted our <a href="https://circu.net/privacy-policy" target="_blank" style="color:#9bbfbd;font-weight:bold;">Privacy Policy</a></p>
            </div>
        </div>

        <div class="col-12 col-md-6 text-right p-0 pb-3 pb-md-0 pl-md-3">
            <button type="submit" id="request-price-tag" class="btn-request-access">BOOK MY APPOINTMENT</button>
        </div>
